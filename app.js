...
const CHAPTERS = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "tvm-2-ear", name: "Effective annual rate (EAR)", expression: "EAR = (1 + rstated/m)<sup>m</sup> \u2212 1", when: "Use whenever you need a true annual return to compare two investments that compound at different frequencies.", problem: "A bank quotes 8% annual interest, compounded quarterly. What is the effective annual rate?", given: ["rstated = 0.08", "m = 4 (quarterly)"], worked: "EAR = (1 + 0.08/4)<sup>4</sup> \u2212 1\nEAR = (1.02)<sup>4</sup> \u2212 1\nEAR \u2248 8.24%\n\n(higher than the quoted 8%, because quarterly\ncompounding earns interest on interest four times a year)", workedExhibit: EXHIBIT_WORKED_EAR },
          { id: "tvm-2-ear-cont", name: "EAR with continuous compounding — advanced", expression: "EAR = e<sup>rstated</sup> \u2212 1", when: "Rare on Level 1; appears when a problem explicitly says \"continuously compounded.\"", problem: "The same 8% rate, but compounded continuously instead of quarterly. What is the effective annual rate?", given: ["rstated = 0.08"], worked: "EAR = e<sup>0.08</sup> \u2212 1\nEAR \u2248 8.33%\n\n(slightly higher still than quarterly compounding \u2014\ncontinuous compounding is the limiting case)" },
        ],
      },
      {
        id: "tvm-3",
        ...
        formulas: [
          { id: "tvm-3-fv", name: "Future value of a single sum", expression: "FV = PV \u00D7 (1 + r)<sup>n</sup>", when: "Wording cue: \"invest/deposit a lump sum today... worth in the future.\"", problem: "You deposit $5,000 today at 6% annual interest for 10 years. What will it grow to?", given: ["PV = $5,000", "r = 0.06", "n = 10"], worked: "FV = 5,000 \u00D7 (1.06)<sup>10</sup>\nFV = 5,000 \u00D7 1.7908\nFV \u2248 $8,954", workedExhibit: EXHIBIT_WORKED_FV },
          { id: "tvm-3-pv", name: "Present value of a single sum", expression: "PV = <span class=\"frac\"><span class=\"num\">FV</span><span class=\"den\">(1 + r)<sup>n</sup></span></span>", when: "Wording cue: \"receive a single amount in the future... worth today.\"", problem: "You'll receive $10,000 in 5 years, at a 7% discount rate. What is that worth today?", given: ["FV = $10,000", "r = 0.07", "n = 5"], worked: "PV = 10,000 / (1.07)<sup>5</sup>\nPV = 10,000 / 1.4026\nPV \u2248 $7,130", workedExhibit: EXHIBIT_WORKED_PV },
        ],
      },
      {
        id: "tvm-4",
        ...
        formulas: [
          { id: "tvm-4-fv-ord", name: "FV of an ordinary annuity", expression: "FV = PMT \u00D7 <span class=\"frac\"><span class=\"num\">(1+r)<sup>n</sup> \u2212 1</span><span class=\"den\">r</span></span>", when: "Equal end-of-period payments; solving for a future accumulated value.", problem: "You deposit $2,000 at the end of every year for 8 years, earning 5% annually. What is the account worth at the end?", given: ["PMT = $2,000", "r = 0.05", "n = 8"], worked: "FV = 2,000 \u00D7 [((1.05)<sup>8</sup> \u2212 1) / 0.05]\nFV = 2,000 \u00D7 9.549\nFV \u2248 $19,098", workedExhibit: EXHIBIT_WORKED_ANNUITY_FV },
          { id: "tvm-4-pv-ord", name: "PV of an ordinary annuity", expression: "PV = PMT \u00D7 <span class=\"frac\"><span class=\"num\">1 \u2212 (1+r)<sup>−n</sup></span><span class=\"den\">r</span></span>", when: "Equal end-of-period payments; solving for today's value of the stream.", problem: "A stream pays $1,500 at the end of each year for 6 years, at a 4% discount rate. What is it worth today?", given: ["PMT = $1,500", "r = 0.04", "n = 6"], worked: "PV = 1,500 \u00D7 [1 \u2212 (1.04)<sup>−6</sup>] / 0.04\nPV = 1,500 \u00D7 5.242\nPV \u2248 $7,863" },
          { id: "tvm-4-due", name: "Annuity due adjustment — advanced", expression: "FVdue = FVordinary \u00D7 (1+r)\nPVdue = PVordinary \u00D7 (1+r)", when: "Same payment stream, but each payment occurs one period earlier than the ordinary case.", problem: "Take that same $1,500-per-year, 6-year, 4% stream from above, but now paid at the beginning of each period instead of the end. What is it worth today?", given: ["PVordinary = $7,863 (from the ordinary-annuity example above)", "r = 0.04"], worked: "PVdue = 7,863 \u00D7 1.04\nPVdue \u2248 $8,177\n\n(about $314 more than the ordinary version,\njust from receiving each payment one period sooner)", workedExhibit: EXHIBIT_WORKED_ANNUITY_PV },
        ],
      },
      {
        id: "tvm-5",
        ...
        formulas: [
          { id: "tvm-5-perp", name: "PV of a level perpetuity", expression: "PV = <span class=\"frac\"><span class=\"num\">PMT</span><span class=\"den\">r</span></span>", when: "Wording cue: \"forever,\" \"perpetual,\" \"in perpetuity,\" level payment.", problem: "A preferred stock pays a level $6 dividend per year forever, starting one year from now, at a 9% discount rate. What is it worth today?", given: ["PMT = $6", "r = 0.09"], worked: "PV = 6 / 0.09\nPV \u2248 $66.67", workedExhibit: EXHIBIT_WORKED_PERPETUITY_LEVEL },
          { id: "tvm-5-gperp", name: "PV of a growing perpetuity — advanced", expression: "PV = <span class=\"frac\"><span class=\"num\">PMT1</span><span class=\"den\">r \u2212 g</span></span>, requires r > g", when: "Same as above, but the payment grows at a constant rate each period.", problem: "That same stock, but the dividend grows 3% every year instead of staying level. What is it worth today?", given: ["PMT1 = $6", "r = 0.09", "g = 0.03"], worked: "PV = 6 / (0.09 \u2212 0.03)\nPV = 6 / 0.06\nPV = $100\n\n(notably higher than the level version, since a\ngrowing stream is worth more at the same starting amount)", workedExhibit: EXHIBIT_WORKED_PERPETUITY_GROWING },
        ],
      },
      {
        id: "tvm-6",
      ...
      },
      {
        ...
        formulas: [
          { id: "tvm-6b-forward", name: "Implied forward rate (1-year rate, 1 year from now)", expression: "(1 + S1) \u00D7 (1 + 1y1y forward) = (1 + S2)<sup>2</sup>", when: "Finding the rate the market implicitly expects for a future period, given two spot rates of different maturities.", problem: "The 1-year spot rate is 4%, and the 2-year spot rate is 5%. What 1-year rate is implied for the period starting one year from now?", given: ["S1 = 0.04 (1-year spot rate)", "S2 = 0.05 (2-year spot rate)"], worked: "(1.04) \u00D7 (1 + forward) = (1.05)<sup>2</sup>\n(1.04) \u00D7 (1 + forward) = 1.1025\n1 + forward = 1.1025 / 1.04\nforward \u2248 6.01%\n\n(the market implicitly predicts 1-year rates rise\nfrom 4% to about 6% one year from now)" },
        ],
      },
      {
        id: "tvm-7",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "probstat-2-addition", name: "Addition rule (general)", expression: "P(A or B) = P(A) + P(B) \u2212 P(A and B)", when: "Finding the probability that either of two events happens.", problem: "The probability a stock's price rises this month is 0.55; the probability its trading volume rises is 0.40; the probability both happen together is 0.25. What is the probability that at least one of these happens?", given: ["P(A) = 0.55 (price rises)", "P(B) = 0.40 (volume rises)", "P(A and B) = 0.25"], worked: "P(A or B) = 0.55 + 0.40 \u2212 0.25\nP(A or B) = 0.70" },
          { id: "probstat-2-mult", name: "Multiplication rule", expression: "P(A and B) = P(A) \u00D7 P(B | A)", when: "Finding the probability that both of two events happen. If independent, simplifies to P(A) \u00D7 P(B).", problem: "The probability a fund manager beats the market in a given year is 0.30. Assuming each year is independent, what is the probability of beating the market two years in a row?", given: ["P(A) = 0.30 (beats market this year)", "P(B) = 0.30 (beats market next year, independent)"], worked: "P(A and B) = 0.30 \u00D7 0.30\nP(A and B) = 0.09, or 9%" },
          { id: "probstat-2-ev", name: "Expected value", expression: "E(X) = \u03A3 [ P(outcome) \u00D7 value of outcome ]", when: "Finding the probability-weighted average outcome.", problem: "A bond has a 90% chance of paying $1,000 at maturity and a 10% chance of defaulting and paying only $400. What is its expected payoff?", given: ["P(pays $1,000) = 0.90", "P(defaults, pays $400) = 0.10"], worked: "E(X) = (0.90 \u00D7 1,000) + (0.10 \u00D7 400)\nE(X) = 900 + 40\nE(X) = $940" },
        ],
      },
      {
        id: "probstat-3",
        ...
        formulas: [
          { id: "probstat-3-var", name: "Sample variance and standard deviation", expression: "s\u00B2 = \u03A3(xi \u2212 mean)\u00B2 / (n \u2212 1)\ns = \u221As\u00B2", when: "Measuring how spread out a data set is.", problem: "A stock's returns over 4 years are 10%, 14%, 6%, and 10%. What is the sample standard deviation of these returns?", given: ["Returns: 10%, 14%, 6%, 10%", "n = 4", "mean = 10%"], worked: "Squared deviations: 0, 16, 16, 0\nVariance = (0+16+16+0) / (4\u22121)\nVariance \u2248 10.67\nStd dev = \u221A10.67 \u2248 3.27%" },
      ...
      },
      {
        ...
        formulas: [
          { id: "probstat-5c-bayes", name: "Bayes' formula", expression: "P(Event | Info) = <span class=\"frac\"><span class=\"num\">P(Info | Event) \u00D7 P(Event)</span><span class=\"den\">P(Info)</span></span>", when: "Updating a probability once new information arrives.", problem: "A fund's prior probability of beating its benchmark in any given year is 30%. In years it beats the benchmark, its manager holds a large cash position 20% of the time; in years it doesn't, that happens 50% of the time. Given the manager currently holds a large cash position, what is the updated probability the fund beats its benchmark this year?", given: ["P(Event) = 0.30 (prior: beats benchmark)", "P(Info | Event) = 0.20 (large cash position, given it beat benchmark)", "P(Info | not Event) = 0.50 (large cash position, given it did not)", "P(not Event) = 0.70"], worked: "P(Info) = (0.20\u00D70.30) + (0.50\u00D70.70)\nP(Info) = 0.06 + 0.35 = 0.41\n\nP(Event | Info) = (0.20 \u00D7 0.30) / 0.41\nP(Event | Info) \u2248 14.6%\n\n(well below the 30% prior \u2014 a large cash position\nis more typical of years the fund underperforms)" },
        ],
      },
      {
        id: "probstat-5d",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "returns-2-hpr", name: "Holding period return", expression: "HPR = <span class=\"frac\"><span class=\"num\">Ending value \u2212 Beginning value + Income</span><span class=\"den\">Beginning value</span></span>", when: "Measuring the total return earned over a single holding period.", problem: "You buy a stock for $50, receive a $1 dividend, and sell it for $54. What is your holding period return?", given: ["Beginning value = $50", "Ending value = $54", "Income = $1 (dividend)"], worked: "HPR = (54 \u2212 50 + 1) / 50\nHPR = 5 / 50\nHPR = 10%" },
        ],
      },
      {
        id: "returns-3",
        ...
        formulas: [
          { id: "returns-3-required", name: "Required rate of return", expression: "Required return = Risk-free rate + Risk premium", when: "Building up the discount rate used to value a risky investment.", problem: "The risk-free rate is 3%, and an analyst assigns this investment a 5% risk premium. What is the required rate of return?", given: ["Risk-free rate = 3%", "Risk premium = 5%"], worked: "Required return = 3% + 5%\nRequired return = 8%" },
        ],
      },
      {
        id: "returns-4",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "reg-2-slope", name: "Regression slope (b1)", expression: "b1 = <span class=\"frac\"><span class=\"num\">Covariance(X,Y)</span><span class=\"den\">Variance(X)</span></span>", when: "Estimating how much Y changes, on average, for a one-unit change in X — this is exactly how a stock's beta is calculated.", problem: "A stock's returns are regressed against market returns. What is the stock's beta?", given: ["Covariance(stock, market) = 0.008", "Variance(market) = 0.005"], worked: "b1 = 0.008 / 0.005\nb1 = 1.6\n\n(this beta plugs directly into the CAPM\nformula you'll see in Portfolio Management)" },
        ],
      },
      {
        id: "reg-3",
  ...
  },
  {
    ...
    number: "08",
    title: "Economics",
    subtitle: "How markets, money, and policy shape the environment every investment sits inside — 8 modules, matching the official CFA Institute outline",
    sections: [
      {
        id: "econ-1",
        title: "Overview",
        body: [`Economics on Level 1 spans eight distinct modules: market structures and firm behavior, business cycles, fiscal policy, monetary policy, geopolitics, international trade, the foreign exchange market, and currency calculations. This chapter follows that same eight-module structure directly, so you can move through it the same way you'd move through the actual curriculum outline.`],
        formulas: [],
      },
      {
        id: "econ-2",
      ...
      },
      {
        id: "econ-3",
        title: "Elasticity",
        body: [`Elasticity measures how sensitive quantity is to a change in price. Demand is elastic if a small price increase causes a large drop in quantity purchased. Demand is inelastic if quantity barely changes even with a large price increase.`],
        formulas: [
          { id: "econ-3-elasticity", name: "Price elasticity of demand", expression: "Elasticity = <span class=\"frac\"><span class=\"num\">% change in quantity demanded</span><span class=\"den\">% change in price</span></span>", when: "Measuring how sensitive demand is to a price change.", problem: "A 10% price increase causes a 25% drop in quantity demanded. Is demand elastic or inelastic?", given: ["% change in price = +10%", "% change in quantity = \u221225%"], worked: "Elasticity = \u221225% / 10%\nElasticity = \u22122.5 (elastic)" },
        ],
      },
      {
        id: "econ-4",
        title: "Module 1 — Characteristics of the four market structures",
        body: [
          `Perfect competition: many small sellers, an identical (undifferentiated) product, and no single seller large enough to influence the market price — each firm is a "price taker" (e.g., agricultural commodities).`,
          `Monopolistic competition: many sellers, but each offers a somewhat differentiated product (through branding, quality, or features), giving each firm a small amount of pricing power despite facing real competition (e.g., restaurants, clothing brands).`,
          `Oligopoly: a small number of large sellers, where each firm's pricing and output decisions noticeably affect — and are affected by — its rivals' decisions. This mutual interdependence is the defining feature (e.g., commercial aircraft manufacturers, wireless carriers).`,
          `Monopoly: a single seller with no close substitutes for its product, giving it substantial, sustained pricing power, often protected by high barriers to entry (e.g., a regional utility with exclusive service rights).`,
        ],
        formulas: [],
      },
      {
        id: "econ-5",
        title: "Module 1 — Breakeven and shutdown points",
        body: [
          `A firm's short-run production decision comes down to comparing the market price it receives to its costs, on a per-unit basis. Average total cost (ATC) includes every cost of production, fixed and variable, spread over each unit produced. Average variable cost (AVC) includes only the costs that change with output — it ignores fixed costs the firm is stuck paying regardless of whether it produces anything.`,
          `The breakeven point is where price equals ATC: at exactly this price, the firm earns zero economic profit — it covers every cost, including a normal return on capital, but no more. Below this price, the firm is losing money, but that alone doesn't mean it should stop producing immediately.`,
          `The shutdown point is where price equals AVC: below this price, the firm can't even cover its variable costs, so producing anything only adds to its losses — at that point, it's better off shutting down and just absorbing its fixed costs alone. Between the shutdown point and the breakeven point, a firm experiencing losses should generally keep producing in the short run anyway, since operating still covers all variable costs plus part of the fixed costs, which is better than covering none of the fixed costs at all.`,
        ],
        formulas: [
          { id: "econ-5-breakeven", name: "Breakeven and shutdown price rules", expression: "Breakeven: Price = ATC\nShutdown: Price = AVC", when: "Deciding whether a firm should keep producing, produce at a loss, or shut down, based on where market price sits relative to its costs.", problem: "A firm's ATC is $40/unit and its AVC is $28/unit. The market price is currently $32/unit. Should the firm keep producing?", given: ["ATC = $40/unit", "AVC = $28/unit", "Market price = $32/unit"], worked: "Price ($32) is below ATC ($40) \u2014 the firm is\nlosing money on a full-cost basis.\n\nPrice ($32) is above AVC ($28) \u2014 the firm still\ncovers all variable costs plus $4/unit toward\nfixed costs.\n\nConclusion: keep producing in the short run,\ndespite the loss \u2014 shutting down would be worse." },
        ],
      },
      {
        id: "econ-6",
        title: "Module 1 — Economies and diseconomies of scale",
        body: [`As a firm increases its scale of production, average costs per unit don't stay constant. Economies of scale occur when average costs fall as output rises — spreading fixed costs over more units, buying inputs in bulk, and specializing labor all tend to push costs down as a firm grows. Beyond some point, though, diseconomies of scale can set in: average costs start rising again as a firm grows too large to manage efficiently, coordination becomes more complex, and communication breaks down across a bigger organization. In perfectly competitive markets, firms are typically assumed to operate at a scale close to their minimum efficient scale (the output level where average cost is lowest); in imperfectly competitive markets (monopoly, oligopoly, monopolistic competition), firms often have more room to grow well past that point before diseconomies bite, given their pricing power and barriers facing potential rivals.`],
        formulas: [],
      },
      {
        id: "econ-7",
        title: "Module 1 — Monopolistic competition: optimal price and pricing strategy",
        body: [`Because each firm's product is at least somewhat differentiated, a monopolistically competitive firm faces its own downward-sloping demand curve, not a flat, price-taking one — meaning it has to choose a price, not simply accept the market's. The profit-maximizing choice, like every market structure, is to produce where marginal revenue equals marginal cost (MR = MC), then charge whatever price the demand curve says buyers will pay for that quantity. Because of that differentiation, price typically sits above marginal cost, and each firm can earn short-run economic profit. In the long run, though, those profits attract new entrants (since barriers to entry are low), competition intensifies, and economic profit tends to erode back toward zero.`],
        formulas: [],
      },
      {
        id: "econ-8",
        title: "Module 1 — Oligopoly: optimal price and pricing strategy",
        body: [`Because oligopoly firms are few and interdependent, pricing strategy is fundamentally about anticipating rivals' reactions, not just customers' — a decision to cut price risks triggering a price war if competitors match the cut, while a decision to raise price risks losing market share if competitors don't follow. One common simplified model, the kinked demand curve, captures this: firms expect rivals to match price cuts (making demand relatively inelastic below the current price) but not match price increases (making demand relatively elastic above it) — the result is that oligopoly prices can stay unusually stable, since neither raising nor lowering price looks attractive. Firms may also pursue tacit or explicit collusion (coordinating on price rather than competing directly), though explicit collusion (cartels) is illegal in most jurisdictions.`],
        formulas: [],
      },
      {
        id: "econ-9",
        title: "Module 1 — Identifying market structure and concentration measures",
        body: [
          `Identifying which market structure a firm actually operates in comes down to observing the number of competitors, how differentiated the product is, and how much pricing power the firm demonstrably has — rather than relying on any single clean-cut rule.`,
          `Concentration measures give this a numeric backbone. The N-firm concentration ratio simply sums the market share of the largest N firms (commonly the top 4). The Herfindahl-Hirschman Index (HHI) goes further, squaring each firm's market share before summing — which gives disproportionately more weight to larger firms, making it more sensitive to genuine market dominance than the simpler concentration ratio. A key limitation of both measures: they say nothing about how contestable a market actually is (how easy it would be for a new entrant to challenge incumbents), which can matter just as much as the current headcount of competitors.`,
        ],
        formulas: [
          { id: "econ-9-hhi", name: "Herfindahl-Hirschman Index (HHI)", expression: "HHI = \u03A3 (market share)<sup>2</sup>, using shares as whole numbers (e.g., 25 for 25%)", when: "Measuring market concentration with more weight on large firms than a simple concentration ratio gives.", problem: "An industry has 4 firms with market shares of 40%, 30%, 20%, and 10%. What is the industry's HHI?", given: ["4 firms with market shares: 40%, 30%, 20%, 10%"], worked: "HHI = 40\u00B2 + 30\u00B2 + 20\u00B2 + 10\u00B2\nHHI = 1,600 + 900 + 400 + 100\nHHI = 3,000\n\n(higher HHI = more concentrated; regulators often\nflag markets above roughly 2,500 as highly concentrated)" },
        ],
      },
      {
        id: "econ-10",
        title: "Module 2 — The business cycle and its phases",
        body: [
          ...
          `Economies move through a repeating pattern called the business cycle, with four recognized phases: expansion (output and employment growing), peak (growth tops out), contraction — a sustained contraction is called a recession — (output and employment shrinking), and trough (the low point, just before expansion resumes). Each phase has recognizable characteristics: expansions typically see rising employment, rising consumer confidence, and rising business investment; contractions see the reverse, often alongside rising unemployment and falling business investment.`,
        ],
        formulas: [],
      },
      {
        id: "econ-11",
        title: "Module 2 — Credit cycles",
        body: [`A credit cycle describes the recurring expansion and contraction of credit availability and borrowing costs over time — related to the business cycle, but not identical to it, and often a leading influence on it. During a credit expansion, lending standards loosen, credit becomes cheaper and easier to obtain, and borrowing rises, often fueling the later stages of an economic expansion. During a credit contraction, lending standards tighten (sometimes sharply, in a "credit crunch"), credit becomes scarcer and more expensive, and reduced borrowing can itself help trigger or deepen an economic contraction. Because credit conditions can shift before broader economic data does, analysts often watch credit cycle indicators as an early signal of where the broader business cycle may be heading.`],
        formulas: [],
      },
      {
        id: "econ-12",
        title: "Module 2 — Economic indicators across the business cycle",
        body: [
          `Different parts of the economy behave differently across the business cycle, and each has indicators economists track: resource use (labor and capital utilization) typically shows rising employment and factory utilization during expansions, and rising unemployment/idle capacity during contractions. Consumer and business activity indicators include consumer confidence surveys, retail sales, and business capital spending — all tend to lead or coincide with the broader cycle. Housing sector activity (building permits, housing starts, home sales) is often watched as an early-moving indicator, since housing decisions are highly sensitive to interest rates and confidence. External trade sector activity (exports, imports, the trade balance) reflects both domestic conditions and conditions in trading-partner economies.`,
          `Economic indicators are commonly classified by timing: leading indicators tend to change before the broader economy does (useful for forecasting — e.g., building permits, stock prices); coincident indicators move together with the broader economy (useful for confirming the current phase — e.g., industrial production, employment levels); lagging indicators change after the broader economy has already turned (useful for confirming a phase has ended — e.g., the unemployment rate, which often keeps rising for a while even after a recession has technically ended).`,
        ],
        formulas: [],
      },
      {
        id: "econ-13",
        title: "Module 3 — Fiscal policy: roles, objectives, and the national debt debate",
        body: [
          `Fiscal policy is a government's use of spending and taxation to influence the economy — distinct from monetary policy, which is controlled by the central bank (covered in the next module). Its core objectives typically include supporting stable economic growth, promoting full employment, and — in some cases — redistributing income or funding specific public goods.`,
          `Whether a country's national debt relative to its GDP "matters" is a genuinely debated question, and it's worth knowing both sides rather than assuming a single settled answer. One view holds that high and rising debt-to-GDP can crowd out private investment, burden future generations with debt service costs, and risk a loss of investor confidence (potentially raising the government's own borrowing costs). The opposing view holds that debt sustainability depends heavily on the specific circumstances — a country borrowing in its own currency, with a central bank able to influence its own interest rates, and with debt funding productive long-term investment, can sustain higher debt-to-GDP than a simple ratio alone would suggest.`,
        ],
        formulas: [],
      },
      {
        id: "econ-14",
        title: "Module 3 — Tools of fiscal policy",
        body: [`Governments have several fiscal levers, each with trade-offs. Taxation (personal income tax, corporate tax, consumption taxes) raises revenue and can be adjusted to stimulate or cool activity, but changes can be slow to legislate and politically contentious. Government spending (infrastructure, public services, defense) directly adds to economic activity, but can be inefficient if poorly targeted and is also often slow to adjust. Transfer payments (unemployment benefits, social security) support demand especially during downturns and can act as automatic stabilizers — they rise automatically in recessions (more people claiming unemployment benefits) without requiring new legislation, and fall automatically in expansions, smoothing the cycle somewhat without deliberate action.`],
        formulas: [],
      },
      {
        id: "econ-15",
        title: "Module 3 — Implementing fiscal policy",
        body: [`A fiscal policy is expansionary when it increases spending, decreases taxes, or both — intended to stimulate a weak economy. It is contractionary when it decreases spending, increases taxes, or both — intended to cool an overheating economy. In practice, implementation faces real difficulties: recognition lag (realizing a problem exists takes time), decision/action lag (legislating a response takes time, especially in divided governments), and impact lag (even after enactment, spending and tax changes take time to actually affect economic activity) — collectively meaning fiscal policy often arrives later than ideal, sometimes even reinforcing the cycle instead of smoothing it if the timing goes wrong.`],
        formulas: [],
      },
      {
        id: "econ-16",
        title: "Module 4 — Roles and objectives of central banks",
        body: [`A central bank (like the US Federal Reserve, the European Central Bank, or the Bank of England) is generally responsible for controlling the money supply and interest rates, with common objectives including price stability (controlling inflation), full employment, and — in many countries — overall financial system stability. Central banks are typically established with some degree of independence from the elected government specifically so that monetary policy decisions (which can require short-term pain, like raising rates during a politically inconvenient time) aren't unduly swayed by short-term political pressure.`],
        formulas: [],
      },
      {
        id: "econ-17",
        title: "Module 4 — Monetary policy tools and the transmission mechanism",
        body: [
          `Central banks influence the economy through several tools. The policy rate (a short-term interest rate the central bank directly controls or heavily influences) is the primary lever — raising it makes borrowing more expensive economy-wide; lowering it makes borrowing cheaper. Reserve requirements (how much of their deposits banks must hold rather than lend out) can be adjusted to loosen or tighten how much banks are able to lend. Open market operations (the central bank buying or selling government securities) directly add or remove money from the banking system. Quantitative easing (large-scale asset purchases, often used when policy rates are already near zero) is a less conventional tool for injecting money into the financial system.`,
          `The monetary transmission mechanism describes how a change in the policy rate eventually flows through to the broader economy: a rate change affects other interest rates (like mortgage and business loan rates), which affects borrowing and spending decisions by households and businesses, which affects aggregate demand, which eventually affects economic growth and inflation — a multi-step chain that takes time to fully play out, which is part of why monetary policy effects are felt with a lag.`,
        ],
        formulas: [],
      },
      {
        id: "econ-18",
        title: "Module 4 — Central bank qualities and targeting regimes",
        body: [`Effective central banks are generally characterized by independence (insulated from short-term political pressure), transparency (clearly communicating objectives and reasoning), and credibility (a track record that makes markets believe the central bank will actually follow through on its stated intentions) — credibility in particular makes policy more effective, since markets and the public adjust their own behavior in anticipation of a central bank's actions when they trust its commitments. Central banks typically anchor policy around one of a few targeting frameworks: inflation targeting (committing to keep inflation near a specific numeric target, the most common modern approach), interest rate targeting (directly targeting a specific policy rate level), or exchange rate targeting (managing policy specifically to keep the currency's value within a desired range against another currency, common in smaller or export-dependent economies). Monetary policy has real limitations too: it can struggle to stimulate a weak economy once rates already sit near zero (a "liquidity trap"), and it works with a lag that makes precise fine-tuning difficult in practice.`],
        formulas: [],
      },
      {
        id: "econ-19",
        title: "Module 4 — Monetary and fiscal policy interaction",
        body: [`Monetary policy (central bank, primarily interest rates/money supply) and fiscal policy (government, primarily spending/taxation) are formally separate, but their effects interact constantly in practice. Loose monetary policy sitting alongside loose fiscal policy can compound stimulus (and inflation risk); loose monetary policy trying to offset tight fiscal policy (or vice versa) can partially cancel each other's intended effect. Coordinated fiscal and monetary policy pointed in the same direction is generally more effective than the two working at cross-purposes — though genuine coordination can be politically difficult, given that the two are typically controlled by different, independently-motivated institutions.`],
        formulas: [],
      },
      {
        id: "econ-20",
        title: "Module 5 — Geopolitics: cooperation versus competition",
        body: [`Geopolitics studies how countries pursue their interests in relation to one another, and those interactions sit on a spectrum between cooperation (trade agreements, alliances, joint institutions) and competition (rivalry over resources, markets, technology, or influence, sometimes escalating to conflict). Most real-world relationships between countries mix both at once — two countries can cooperate closely on trade while competing sharply in another domain, like technology standards or military influence in a shared region. Analysts watch where a relationship sits on this spectrum, and how it's shifting, since that trajectory itself carries information about future economic and market risk.`],
        formulas: [],
      },
      {
        id: "econ-21",
        title: "Module 5 — Geopolitics and globalization",
        body: [`Globalization — the growing economic, technological, and cultural integration of countries — has generally been supported by a cooperative geopolitical environment (open trade rules, stable alliances, shared institutions), and can just as easily be slowed or partially reversed by a shift toward competition (rising tariffs, technology restrictions, reshoring of supply chains). The relationship runs both ways: geopolitics shapes how much globalization is possible, while the depth of global economic integration itself changes what's actually at stake when geopolitical tensions rise — deeply intertwined economies have more to lose from open conflict, which can itself act as a stabilizing force, but also means economic tools (like sanctions) become a more potent instrument of geopolitical competition.`],
        formulas: [],
      },
      {
        id: "econ-22",
        title: "Module 5 — International organizations facilitating trade",
        body: [`Three institutions come up repeatedly in this context. The World Bank provides financing and advice to developing countries, primarily for long-term development projects (infrastructure, education, health) rather than short-term financial crises. The International Monetary Fund (IMF) focuses on global monetary cooperation and financial stability, most visibly by providing short-term financial assistance to countries facing balance-of-payments crises, typically attached to policy conditions. The World Trade Organization (WTO) sets and enforces rules for international trade among member countries, and provides a formal mechanism for resolving trade disputes between them — its existence is part of why the "rules-based" characterization of the modern trading system is meaningful, rather than trade simply happening on an ad hoc, case-by-case basis.`],
        formulas: [],
      },
      {
        id: "econ-23",
        title: "Module 5 — Geopolitical risk",
        body: [`Geopolitical risk is the risk that political, military, or diplomatic developments between countries (or within a country, with cross-border implications) disrupt economic activity, trade, or markets. It's often described along two dimensions: the likelihood of an event occurring, and the potential magnitude of its impact if it does — a low-likelihood, high-impact event (like a major regional conflict) can matter just as much to risk management as a higher-likelihood, lower-impact one (like a routine trade dispute). Geopolitical risk is also notoriously difficult to quantify with the same statistical tools used elsewhere in this course, since relevant historical events are relatively rare and rarely repeat in the same form.`],
        formulas: [],
      },
      {
        id: "econ-24",
        title: "Module 5 — Tools of geopolitics",
        body: [`Countries have a range of tools to pursue geopolitical objectives short of military conflict. Economic sanctions restrict trade or financial dealings with a targeted country, company, or individual. Tariffs and trade restrictions (covered in more depth in the next module) can be used as leverage, not just as ordinary economic policy. Export controls restrict the sale of sensitive technology or goods to specific countries. Alliances and diplomatic agreements formalize cooperative relationships, while their absence (or breakdown) can signal rising competition. Each tool has different economic reach and different regions or economies it tends to affect most — sanctions on a major commodity exporter, for example, can ripple through global prices well beyond the targeted country itself.`],
        formulas: [],
      },
      {
        id: "econ-25",
        title: "Module 5 — The impact of geopolitical risk on investments",
        body: [`Geopolitical risk affects investments through several channels: direct exposure (a company with significant operations or revenue in an affected region or country), supply chain exposure (a company reliant on inputs or manufacturing from an affected region, even without operating there directly), currency and capital flow effects (geopolitical tension often triggers capital flight from perceived risk zones), and broad market risk premium effects (heightened uncertainty tends to raise required returns and lower valuations across markets generally, not just in directly affected names). Because geopolitical risk is hard to model statistically, it's often addressed through scenario analysis and stress testing rather than the standard probability-based tools used elsewhere in this course.`],
        formulas: [],
      },
      {
        id: "econ-26",
        title: "Module 6 — Benefits and costs of international trade",
        body: [`Countries trade because of comparative advantage — even if one country can produce every good more efficiently than another, both countries still gain by each specializing in what it produces relatively best, then trading for the rest. The benefits of trade include: access to a wider variety of goods, lower prices through specialization and scale, and increased competition that can drive innovation. The costs include: domestic industries facing import competition can shrink or fail, displacing workers in those specific industries even while the economy gains in aggregate, and increased economic interdependence with trading partners, which can be a source of vulnerability during disruptions (as covered in the geopolitics module above).`],
        formulas: [],
      },
      {
        id: "econ-27",
        title: "Module 6 — Trade restrictions: tariffs, quotas, and export subsidies",
        body: [`Governments have several tools to restrict or shape trade. A tariff is a tax on imported goods, raising their price to domestic consumers, protecting domestic producers from foreign competition, and generating government revenue — but at the cost of higher prices for domestic buyers and, often, retaliatory tariffs from trading partners. A quota is a direct limit on the physical quantity of a good that can be imported, protecting domestic producers similarly to a tariff, but without generating government revenue (unless quota licenses are auctioned) and typically causing a larger domestic price increase for a given amount of import reduction. An export subsidy is a government payment to domestic producers specifically for goods sold abroad, making those exports more price-competitive internationally — but distorting production decisions and often provoking trade disputes or countervailing tariffs from the importing country.`],
        formulas: [],
      },
      {
        id: "econ-28",
        title: "Module 6 — Trading blocs, common markets, and economic unions",
        body: [`Countries often formalize deeper trade cooperation through structured agreements, generally deepening in this order: a free trade area removes tariffs and quotas between member countries, but each member keeps its own external trade policy toward non-members. A customs union goes further, adding a common external tariff policy toward non-members. A common market adds free movement of labor and capital between members, on top of free trade in goods. An economic union goes furthest, adding coordinated (or fully unified) economic policy — potentially including a shared currency — across members. The motivation throughout is the same logic as bilateral trade, just scaled up: larger effective markets, more specialization, and greater bargaining power collectively than any single member would have alone — traded off against each member's declining ability to set fully independent economic policy as integration deepens.`],
        formulas: [],
      },
      {
        id: "econ-29",
        title: "Module 7 — The foreign exchange market",
        body: [
          `The foreign exchange (FX) market is where currencies are traded, and it's the largest, most liquid financial market in the world, operating nearly continuously across global trading centers. Its participants include commercial banks (the largest players, trading on their own behalf and for clients), central banks (intervening at times to influence their own currency's value), corporations (converting currency for cross-border business), and investors/speculators (trading currencies as an asset class or to hedge other exposures).`,
          `An exchange rate is quoted as one currency's price in terms of another. A critical habit: always identify which currency is the price currency (the amount quoted) and which is the base currency (the one unit being priced) — mixing this up is one of the most common, avoidable calculation errors.`,
          `A nominal exchange rate is the rate you actually see quoted, with no adjustment for inflation differences between the two countries. A real exchange rate adjusts the nominal rate for the inflation differential between the two countries, better reflecting the true relative purchasing power of each currency over time — two countries could have a stable nominal exchange rate while their real exchange rate drifts meaningfully, if one has persistently higher inflation than the other.`,
        ],
        formulas: [
          { id: "econ-29-pctchange", name: "Percentage change in a currency's value", expression: "% change = <span class=\"frac\"><span class=\"num\">New rate \u2212 Old rate</span><span class=\"den\">Old rate</span></span>", when: "Measuring how much one currency has moved relative to another over a period.", problem: "EUR/USD moves from 1.05 to 1.12 over the year. By what percentage did the euro move against the dollar?", given: ["Old rate (EUR/USD) = 1.05", "New rate (EUR/USD) = 1.12"], worked: "% change = (1.12 \u2212 1.05) / 1.05\n% change = 0.07 / 1.05\n% change \u2248 +6.67%\n\n(the euro strengthened about 6.67% against\nthe dollar, since more dollars are now needed\nto buy one euro)" },
        ],
      },
      {
        id: "econ-30",
        title: "Module 7 — Exchange rate regimes",
        body: [`Countries choose from a range of exchange rate regimes, differing in how much the government/central bank intervenes to manage the currency's value. Under a floating (flexible) regime, the exchange rate is determined by market supply and demand with little to no government intervention. Under a fixed (pegged) regime, the government commits to maintaining the currency at (or very near) a specific value against another currency or basket, actively intervening as needed to defend that level. Between these extremes, a managed float allows the currency to move within the market but with the central bank actively intervening at times to influence its direction, and a currency board is a particularly rigid fixed-rate arrangement, backing the domestic currency fully with foreign reserves. Each regime trades off exchange rate stability (useful for trade and investment planning) against monetary policy independence (a fixed regime constrains a central bank's ability to set interest rates independently, since defending the peg takes priority).`],
        formulas: [],
      },
      {
        id: "econ-31",
        title: "Module 7 — Effects on trade, capital flows, and capital restrictions",
        body: [
          `Exchange rates directly affect a country's international trade and capital flows. A stronger (appreciating) currency makes a country's exports more expensive for foreign buyers (potentially hurting export competitiveness) while making imports cheaper for domestic buyers. A weaker (depreciating) currency does the reverse. A country's balance of payments tracks all its economic transactions with the rest of the world, split into the current account (trade in goods/services plus income flows) and the capital/financial account (cross-border investment flows). Strong capital inflows (foreign investors buying a country's assets) generally increase demand for that country's currency, pushing its value up; capital outflows tend to have the opposite effect.`,
          `Governments sometimes impose capital restrictions — limits on money flowing into or out of the country. Common objectives include: protecting a fixed or managed exchange rate from destabilizing speculative flows, preserving scarce foreign currency reserves, maintaining domestic monetary policy independence (preventing capital flows from undermining the central bank's intended policy stance), and, at times, addressing financial stability concerns during a crisis.`,
        ],
        formulas: [],
      },
      {
        id: "econ-32",
        title: "Module 8 — Currency cross-rates",
        ...
        formulas: [
          { id: "econ-32-cross", name: "Cross rate calculation", expression: "(A/B) = (A/C) \u00D7 (C/B)", when: "Finding the exchange rate between two currencies, given each one's rate against a common third currency.", problem: "EUR/USD = 1.10 and GBP/USD = 1.25. What is the EUR/GBP exchange rate?", given: ["EUR/USD = 1.10", "GBP/USD = 1.25"], worked: "EUR/GBP = (EUR/USD) \u00F7 (GBP/USD)\nEUR/GBP = 1.10 / 1.25\nEUR/GBP = 0.88" },
        ],
      },
      {
        id: "econ-33",
        title: "Module 8 — Forward rates, points, and the premium/discount",
        body: [
          ...
          `The gap between the forward rate and the spot rate can be expressed two ways: in forward points (the raw numerical difference, often quoted in small units like pips, and simply added to or subtracted from the spot rate to get the forward rate), or in percentage terms (that same difference expressed as a percentage of the spot rate — more useful for comparing premiums/discounts across currency pairs with very different price scales).`,
        ],
        formulas: [
          { id: "econ-33-points", name: "Forward rate from forward points", expression: "Forward rate = Spot rate + Forward points (points quoted in the same decimal units as the rate)", when: "Building a forward rate from a quoted spot rate and forward points.", problem: "The EUR/USD spot rate is 1.1050, and the market quotes forward points of +0.0025 (25 pips). What is the forward rate?", given: ["Spot rate (EUR/USD) = 1.1050", "Forward points = +0.0025 (25 pips)"], worked: "Forward rate = 1.1050 + 0.0025\nForward rate = 1.1075\n\n(a positive point adjustment here means EUR\ntrades at a forward premium against USD)" },
          { id: "econ-33-parity", name: "Forward premium/discount (interest rate parity, approximate)", expression: "Forward premium/discount \u2248 Domestic interest rate \u2212 Foreign interest rate", when: "Estimating whether a currency should trade at a forward premium or discount, based on the interest rate differential between the two countries.", problem: "The US risk-free rate is 5% and the eurozone risk-free rate is 2%. Should the euro trade at a forward premium or discount against the dollar?", given: ["US risk-free rate = 5%", "Eurozone risk-free rate = 2%"], worked: "Forward premium (EUR) \u2248 5% \u2212 2%\nForward premium (EUR) \u2248 3%\n\n(the lower-rate currency, EUR, is expected\nto trade at a forward premium against USD)" },
        ],
      },
      {
        id: "econ-34",
        ...
        decisionRows: [
          ...
          { cue: "Market with many differentiated sellers, some pricing power", formula: "Monopolistic competition", section: "econ-4" },
          { cue: "One seller, no substitutes, price-setting power", formula: "Monopoly", section: "econ-4" },
          { cue: "A few large, interdependent firms", formula: "Oligopoly", section: "econ-4" },
          { cue: "Deciding whether a firm should keep producing at a loss or shut down", formula: "Breakeven / shutdown points", section: "econ-5" },
          { cue: "Average costs falling (or rising) as a firm scales up", formula: "Economies / diseconomies of scale", section: "econ-6" },
          { cue: "How concentrated a market is, weighting larger firms more", formula: "Herfindahl-Hirschman Index (HHI)", section: "econ-9" },
          { cue: "The repeating pattern of expansion/peak/contraction/trough", formula: "Business cycle", section: "econ-10" },
          { cue: "Expansion and contraction of credit availability and borrowing costs", formula: "Credit cycle", section: "econ-11" },
          { cue: "A signal that changes before the broader economy does", formula: "Leading economic indicator", section: "econ-12" },
          { cue: "Whether a country's debt-to-GDP level is a real concern", formula: "National debt debate", section: "econ-13" },
          { cue: "Automatic stabilizers like unemployment benefits", formula: "Fiscal policy tools (transfer payments)", section: "econ-14" },
          { cue: "Government changing spending or tax rates", formula: "Fiscal policy (expansionary/contractionary)", section: "econ-15" },
          { cue: "Central bank raising/lowering its policy rate", formula: "Monetary policy tools", section: "econ-17" },
          { cue: "A central bank committing to a specific inflation number", formula: "Inflation targeting", section: "econ-18" },
          { cue: "Trade disputes, sanctions, or regional conflict affecting markets", formula: "Geopolitical risk", section: "econ-23" },
          { cue: "The World Bank, IMF, or WTO", formula: "International organizations", section: "econ-22" },
          { cue: "A tax on imported goods", formula: "Tariff", section: "econ-27" },
          { cue: "A direct limit on the quantity of a good that can be imported", formula: "Quota", section: "econ-27" },
          { cue: "Countries sharing a common external tariff, but not free labor movement", formula: "Customs union", section: "econ-28" },
          { cue: "How much a currency has moved relative to another, in percentage terms", formula: "% change in exchange rate", section: "econ-29" },
          { cue: "A currency pegged to another at a fixed value", formula: "Fixed exchange rate regime", section: "econ-30" },
          { cue: "Given two currencies' rates against a common third currency", formula: "Cross rate calculation", section: "econ-32" },
          { cue: "Building a forward rate from a spot rate and quoted points", formula: "Forward points", section: "econ-33" },
        ],
        formulas: [],
      },
      {
        ...
        referenceRows: [
          ...
          { item: "Monetary vs. fiscal policy", detail: "Monetary policy = central bank; fiscal policy = government — not the same body, and not always coordinated." },
          ...
          { item: "Currency appreciation as automatically \"good\"", detail: "It helps importers and travelers but can hurt exporters — the effect depends on which side of the trade you're on." },
          { item: "Confusing the breakeven and shutdown points", detail: "Breakeven is where price = ATC (zero economic profit); shutdown is the lower price = AVC (below this, stop producing)." },
          { item: "Treating tariffs and quotas as economically identical", detail: "Both restrict trade and raise domestic prices, but only a tariff generates government revenue directly." },
          { item: "Assuming geopolitical risk only affects directly-exposed companies", detail: "Supply chain exposure and broad market risk-premium effects can matter even without direct operations in an affected region." },
          { item: "Confusing nominal and real exchange rates", detail: "The real rate adjusts for the inflation differential between the two countries — a stable nominal rate can still mask a drifting real rate." },
        ],
        formulas: [],
      },
    ],
  },
  {
    ...
    subtitle: "Reading a company's financial statements and turning them into insight — 12 modules, matching the official CFA Institute outline",
    sections: [
      {
        id: "fsa-1",
        title: "Overview",
        body: [`Financial Statement Analysis spans twelve modules: an introduction to the framework, deep dives into each of the three core statements, inventories, long-term assets, long-term liabilities and equity, income taxes, financial reporting quality, financial analysis techniques, and financial statement modeling. This chapter follows that same twelve-module structure directly.`],
        formulas: [],
      },
      {
        id: "fsa-1b",
        title: "Module 1 — The financial statement analysis framework and its roles",
        body: [
          `A structured approach to financial statement analysis generally follows a repeatable sequence: state the purpose and context of the analysis (what question are you actually trying to answer, and for whom); gather data (financial statements plus other information, covered later in this module); process the data (calculating ratios, common-size statements, and other adjustments); analyze/interpret the processed data; develop and communicate conclusions/recommendations; and follow up (updating the analysis as new information arrives). Skipping the first step is a common, costly mistake — the "right" ratios and adjustments to use often depend entirely on what the analysis is actually for.`,
          `Financial statement analysis serves several distinct roles depending on the user: equity analysts use it to value companies and forecast performance; credit analysts use it to assess a borrower's ability to repay debt; auditors use it to assess whether the statements themselves are fairly presented; regulators use it to monitor compliance and financial stability; and a company's own management uses it internally to monitor performance and support decision-making.`,
        ],
        formulas: [],
      },
      {
        id: "fsa-1c",
        title: "Module 1 — Regulatory filings, notes, management's commentary, and audit reports",
        body: [
          `Regulatory filings (like the annual report filed with securities regulators) are the primary formal source of a company's financial statements, and typically far more detailed than a glossy shareholder annual report — worth going to directly rather than relying on summaries.`,
          `Financial statement notes and supplementary information disclose the specific accounting policies and estimates management used, along with detail not visible in the summary statement lines themselves (like a breakdown of debt maturities, or the assumptions behind a pension estimate) — analysts routinely find the real story in the notes, not the headline numbers.`,
          `Management's commentary (sometimes called management's discussion and analysis, or MD&A) gives management's own narrative explanation of results, trends, and outlook — useful context, but written by an interested party, so it's read alongside the numbers, not as a substitute for them.`,
          `The audit report expresses an independent auditor's opinion on whether the financial statements are fairly presented in accordance with the relevant accounting standards. An unqualified (clean) opinion is the norm and the goal; a qualified opinion, adverse opinion, or disclaimer of opinion are all warning signs worth investigating further, in ascending order of severity.`,
        ],
        formulas: [],
      },
      {
        id: "fsa-1d",
        title: "Module 1 — Alternative reporting systems and other information sources",
        body: [
          `Not every company reports under the same accounting standards. The two dominant frameworks are International Financial Reporting Standards (IFRS), used in most of the world, and US Generally Accepted Accounting Principles (US GAAP), used in the United States. The two frameworks have converged substantially over time but still differ in real, analytically important ways (several of which come up later in this chapter — inventory method restrictions, lease accounting nuances, and others) — comparing companies reporting under different frameworks without adjusting for these differences can distort an analysis. Because standards themselves evolve, analysts also need to monitor ongoing developments in financial reporting standards, since a rule change can meaningfully affect reported numbers and their comparability over time, even for the same company.`,
          `Beyond the annual and interim financial reports themselves, analysts draw on other information sources: industry and economic data (to provide context for a company's results), information from a company's competitors and suppliers/customers (revealing details a company's own filings might not), and companies' investor relations materials, earnings calls, and press releases (providing more timely, if less audited, updates between formal filing periods).`,
        ],
        formulas: [],
      },
      {
      ...
      {
        id: "fsa-3",
        title: "Module 2 — Revenue and expense recognition",
        body: [
          `Under accrual accounting, revenue is recognized when it is earned — not necessarily when cash is received. A company that ships goods on credit records the sale immediately, even though cash arrives later. Specific applications get more nuanced: a long-term construction contract may recognize revenue gradually as work is completed (rather than all at once at final delivery), and a company that both sells a product and provides ongoing service may need to split a single contract's revenue between the two, recognizing each on its own appropriate schedule. The choice and timing of revenue recognition can materially affect reported results — recognizing revenue earlier makes current performance look stronger, which is exactly why revenue recognition is one of the more scrutinized areas of financial reporting.`,
          `Expenses are recognized in the same period as the revenue they helped generate (the matching principle). A key distinction: costs that provide benefit only in the current period are expensed immediately (like most routine operating costs), while costs that provide benefit over multiple future periods are capitalized — recorded as an asset and then expensed gradually over those future periods (like the equipment purchase covered in the depreciation section below). Capitalizing a cost instead of expensing it immediately makes current-period profit look higher (since less is subtracted from revenue right away) and current-period assets look higher — a distinction with real analytical consequences when comparing companies that make different capitalization choices for similar costs.`,
        ],
        formulas: [],
      },
      {
        id: "fsa-3f",
        title: "Module 2 — Non-recurring items and changes in accounting policy",
        body: [`Not every line on the income statement reflects the company's ongoing, sustainable operations, and analysts generally want to separate the two. Discontinued operations are business segments the company has sold or is in the process of exiting — reported separately from continuing operations, since including them with ongoing results would distort forward-looking analysis. Unusual or infrequent items (a large lawsuit settlement, a natural disaster loss) are one-time events that aren't part of normal operations but don't rise to the level of a separately reported discontinued operation — still worth adjusting out when assessing sustainable, recurring earnings. Changes in accounting policy (like switching inventory methods) can also distort period-to-period comparisons and are typically disclosed and, where required, applied retrospectively (restating prior periods) so like-for-like comparison remains possible. The consistent theme across all three: an analyst assessing a company's sustainable earning power generally wants to identify and adjust for anything that isn't likely to recur.`],
        formulas: [],
      },
      {
        id: "fsa-5d",
      ...
      {
        id: "fsa-3e",
        title: "Module 3 — Intangible assets: reporting and disclosures",
        body: [`Intangible assets are non-physical assets expected to provide economic benefit over multiple periods — patents, trademarks, customer relationships, software, and similar items. How an intangible asset is reported depends heavily on its origin. A purchased intangible (bought from another party) is recorded on the balance sheet at its purchase cost. An intangible acquired in a business combination is recognized separately at fair value as part of the acquisition accounting (a specific rule distinct from an ordinary standalone purchase). An internally developed intangible is treated very differently: under both IFRS and US GAAP, the research phase of internal development is expensed as incurred, while only costs incurred after technical/commercial feasibility is established (the development phase, and only under IFRS's more permissive treatment) may be capitalized — meaning many internally developed intangibles (like an internally built brand) never appear on the balance sheet at all, understating a company's true intangible asset base relative to a company that grew through acquisition instead. Intangible assets with a finite useful life are amortized over that life, similar to depreciation; intangible assets with an indefinite useful life (where no foreseeable limit exists) are not amortized, but are tested for impairment instead.`],
        formulas: [],
      },
      {
        id: "fsa-3f2",
        title: "Module 3 — Goodwill: reporting and disclosures",
        body: [`Goodwill arises specifically when one company acquires another for more than the fair value of the acquired company's identifiable net assets — the premium paid, often reflecting expected synergies, brand value, or workforce quality that don't qualify as separately identifiable intangible assets under accounting rules. Goodwill is not amortized; instead, it's tested for impairment at least annually, and written down if its estimated value has fallen below its carrying amount. Because goodwill only appears through acquisition (never generated internally), and because impairment testing involves significant management judgment, analysts often examine goodwill and its impairment history closely — a large goodwill balance paired with a history of impairments can be a signal of past overpayment for acquisitions.`],
        formulas: [],
      },
      {
        id: "fsa-3g",
      ...
      {
        id: "fsa-4b",
        title: "Module 3 — Common-size balance sheets",
        body: [`A common-size balance sheet restates every line item as a percentage of total assets, the balance sheet's equivalent of the common-size income statement covered later in this chapter — making it possible to compare a small company's balance sheet structure directly against a much larger one, or to track how a single company's own structure shifts over time, without the raw dollar figures getting in the way.`],
        formulas: [
          { id: "fsa-4b-commonsize", name: "Common-size balance sheet line item", expression: "Common-size % = <span class=\"frac\"><span class=\"num\">Line item</span><span class=\"den\">Total assets</span></span>", when: "Restating a balance sheet line as a percentage of total assets, to compare companies of different sizes.", problem: "A company has $2,000,000 of inventory and $10,000,000 of total assets. What is inventory's common-size percentage?", given: ["Inventory = $2,000,000", "Total assets = $10,000,000"], worked: "Inventory % = 2,000,000 / 10,000,000\nInventory % = 20%" },
        ],
      },
      {
        id: "fsa-4",
        title: "Module 3 & 11 — Key ratio categories, with worked examples",
        body: [
        ...
        formulas: [
          { id: "fsa-4-current", name: "Current ratio (liquidity)", expression: "<span class=\"frac\"><span class=\"num\">Current assets</span><span class=\"den\">Current liabilities</span></span>", when: "Assessing ability to meet short-term obligations.", problem: "A company has current assets of $500,000 and current liabilities of $250,000. What is its current ratio?", given: ["Current assets = $500,000", "Current liabilities = $250,000"], worked: "Current ratio = 500,000 / 250,000\nCurrent ratio = 2.0" },
          { id: "fsa-4-de", name: "Debt-to-equity ratio (solvency)", expression: "<span class=\"frac\"><span class=\"num\">Total debt</span><span class=\"den\">Total equity</span></span>", when: "Assessing leverage / ability to meet long-term obligations.", problem: "A company has total debt of $3 million and total equity of $2 million. What is its debt-to-equity ratio?", given: ["Total debt = $3,000,000", "Total equity = $2,000,000"], worked: "Debt-to-equity = 3,000,000 / 2,000,000\nDebt-to-equity = 1.5" },
          { id: "fsa-4-margin", name: "Net profit margin (profitability)", expression: "<span class=\"frac\"><span class=\"num\">Net income</span><span class=\"den\">Revenue</span></span>", when: "Assessing how much profit is generated per dollar of sales.", problem: "A company has net income of $400,000 on revenue of $5,000,000. What is its net profit margin?", given: ["Net income = $400,000", "Revenue = $5,000,000"], worked: "Net profit margin = 400,000 / 5,000,000\nNet profit margin = 8%" },
          { id: "fsa-4-turnover", name: "Inventory turnover (activity)", expression: "<span class=\"frac\"><span class=\"num\">Cost of goods sold</span><span class=\"den\">Average inventory</span></span>", when: "Assessing how efficiently inventory is used.", problem: "A company has COGS of $2,000,000 and average inventory of $400,000. What is its inventory turnover?", given: ["COGS = $2,000,000", "Average inventory = $400,000"], worked: "Inventory turnover = 2,000,000 / 400,000\nInventory turnover = 5 times per year" },
        ],
      },
      {
        id: "fsa-cf1",
        title: "Module 4 — Linking the cash flow statement to the other statements",
        body: [`The cash flow statement doesn't stand alone — it's built directly from the income statement and the balance sheet. The starting point for operating cash flow (under the indirect method, covered next) is net income, straight from the income statement. From there, non-cash items on the income statement (like depreciation and amortization) are added back, since they reduced reported profit without actually using any cash. Changes in working capital accounts (receivables, inventory, payables) come from comparing this period's balance sheet to last period's — an increase in receivables, for example, means the company recorded revenue it hasn't yet collected in cash, so that increase gets subtracted from net income to arrive at actual operating cash flow. This tight linkage is exactly why analysts cross-check all three statements together rather than reading any one in isolation.`],
        formulas: [],
      },
      {
        id: "fsa-cf2",
        title: "Module 4 — Preparing the cash flow statement: direct and indirect methods",
        body: [
          `Both methods report identical totals for investing and financing activities, and an identical bottom-line total for operating cash flow — they only differ in how the operating section is presented.`,
          `The indirect method (used by the large majority of companies in practice) starts with net income and adjusts it: add back non-cash expenses (depreciation, amortization), then adjust for changes in working capital accounts (an increase in a current asset like receivables or inventory is a use of cash, subtracted; an increase in a current liability like payables is a source of cash, added).`,
          `The direct method instead lists actual operating cash receipts and payments directly — cash collected from customers, cash paid to suppliers, cash paid for operating expenses, and so on — arriving at the same operating cash flow total through a fundamentally more transparent (but less commonly reported) presentation. Building it requires converting each accrual-based income statement line into its cash-basis equivalent, using the same balance sheet change data the indirect method uses, just applied item by item rather than as a single net adjustment to net income.`,
        ],
        formulas: [
          { id: "fsa-cf2-indirect", name: "Operating cash flow (indirect method, simplified)", expression: "CFO = Net income + Non-cash expenses \u2212 Increase in working capital assets + Increase in working capital liabilities", when: "The standard, most commonly seen presentation of operating cash flow.", problem: "A company has net income of $500,000, depreciation of $80,000, an increase in receivables of $30,000, and an increase in payables of $20,000. What is operating cash flow?", given: ["Net income = $500,000", "Depreciation = $80,000", "Increase in receivables = $30,000", "Increase in payables = $20,000"], worked: "CFO = 500,000 + 80,000 \u2212 30,000 + 20,000\nCFO = $570,000" },
        ],
      },
      {
        id: "fsa-cf3",
        title: "Module 4 — Converting cash flows from indirect to direct",
        body: [`Since both methods must arrive at the same total operating cash flow, an indirect-method statement can always be converted into a direct-method equivalent, working line by line: cash collected from customers = revenue \u2212 increase in receivables (or + a decrease); cash paid to suppliers = cost of goods sold + increase in inventory \u2212 increase in payables (adjusting each direction as appropriate); cash paid for operating expenses = operating expenses \u2212 increase in related accrued liabilities. This conversion is a common exam skill precisely because it tests whether you genuinely understand the accrual-to-cash relationship, rather than just memorizing the indirect method's shortcut format.`],
        formulas: [
          { id: "fsa-cf3-collections", name: "Cash collected from customers (direct method)", expression: "Cash collections = Revenue \u2212 Increase in accounts receivable (or + decrease)", when: "Converting accrual-basis revenue into its cash-basis equivalent.", problem: "A company reports $1,000,000 of revenue, and accounts receivable increased by $60,000 over the period. How much cash did it actually collect from customers?", given: ["Revenue = $1,000,000", "Increase in receivables = $60,000"], worked: "Cash collections = 1,000,000 \u2212 60,000\nCash collections = $940,000\n\n(the $60,000 increase in receivables means that much\nof reported revenue has not yet been collected in cash)" },
        ],
      },
      {
        id: "fsa-cf4",
        title: "Module 4 — IFRS vs. US GAAP cash flow statement differences",
        body: [`Despite substantial convergence between the two frameworks, real differences remain in cash flow statement classification. Interest paid and interest received: US GAAP requires both be classified as operating activities; IFRS allows a choice — interest paid can be operating or financing, and interest received can be operating or investing. Dividends paid: US GAAP requires financing activities; IFRS allows a choice between operating or financing. Dividends received: US GAAP requires operating activities; IFRS allows a choice between operating or investing. These classification differences mean a direct, unadjusted comparison of "operating cash flow" between an IFRS reporter and a US GAAP reporter can be misleading unless an analyst checks (and if necessary, reclassifies) how each company has chosen to present these specific items.`],
        formulas: [],
      },
      {
        id: "fsa-cf5",
        title: "Module 5 — Analyzing reported and common-size cash flow statements",
        body: [`Beyond simply reading the bottom-line totals, analysts examine the composition and trend of cash flows over time. A healthy, mature company typically shows positive operating cash flow, negative investing cash flow (reinvesting in the business), and some mix of financing activity depending on its capital structure decisions — a company showing negative operating cash flow alongside positive financing cash flow (raising money externally just to fund day-to-day operations) is a meaningful warning sign. A common-size cash flow statement restates each line as a percentage of total revenue (rather than total assets, as with the balance sheet), making it easier to compare cash flow efficiency across companies of different sizes or track a single company's own trend over time.`],
        formulas: [],
      },
      {
        id: "fsa-cf6",
        title: "Module 5 — FCFE and cash flow ratios",
        body: [`Free cash flow to equity (FCFE) narrows FCFF (covered later in this chapter) down to just the cash available to equity holders specifically, after also accounting for net payments to and from debtholders. Beyond FCFF and FCFE, several ratios use cash flow figures directly rather than accrual-based net income: performance ratios (like cash flow to revenue, showing how much of each dollar of sales actually converts to operating cash) and coverage ratios (like cash flow coverage of interest or debt, showing how comfortably operating cash flow covers fixed financial obligations) — all valued by analysts specifically because they're harder to manipulate through the accounting choices covered in the Financial Reporting Quality module later in this chapter.`],
        formulas: [
          { id: "fsa-cf6-fcfe", name: "FCFE (starting from FCFF) — advanced", expression: "FCFE = FCFF \u2212 Interest \u00D7 (1\u2212tax rate) + Net borrowing", when: "Narrowing cash available to all capital providers down to cash available specifically to equity holders.", problem: "A company's FCFF is $1,925,000. It pays $300,000 of interest (25% tax rate) and takes on $150,000 of net new borrowing during the year. What is its FCFE?", given: ["FCFF = $1,925,000", "Interest = $300,000", "Tax rate = 0.25", "Net borrowing = $150,000"], worked: "FCFE = 1,925,000 \u2212 300,000\u00D7(1\u22120.25) + 150,000\nFCFE = 1,925,000 \u2212 225,000 + 150,000\nFCFE = $1,850,000" },
          { id: "fsa-cf6-coverage", name: "Cash flow coverage of interest", expression: "<span class=\"frac\"><span class=\"num\">Operating cash flow + Interest paid + Taxes paid</span><span class=\"den\">Interest paid</span></span>", when: "Assessing how comfortably operating cash flow covers interest obligations — a cash-based alternative to the accrual-based interest coverage ratio.", problem: "A company's operating cash flow is $900,000, it paid $100,000 of interest and $150,000 of taxes during the period. How many times over does operating cash flow cover its interest payments?", given: ["Operating cash flow = $900,000", "Interest paid = $100,000", "Taxes paid = $150,000"], worked: "Coverage = (900,000 + 100,000 + 150,000) / 100,000\nCoverage = 1,150,000 / 100,000\nCoverage = 11.5 times" },
        ],
      },
      {
        id: "fsa-5e",
      ...
      },
      {
        ...
        body: [
          `Financial reporting quality and the quality of results are related but distinct ideas, worth keeping separate. Financial reporting quality asks whether the financial statements themselves are prepared honestly, in accordance with applicable standards, and with full, transparent disclosure — a company can have high reporting quality even in a bad year, simply by reporting that bad year accurately. The quality of results (sometimes broken into quality of earnings, quality of cash flow, and quality of balance sheet items) asks a separate question: are the underlying economic results themselves good — sustainable, adequately profitable, generating real cash — regardless of how faithfully they're reported. A company can have perfectly high-quality reporting of genuinely poor results, or (more concerning to an analyst) lower-quality reporting that flatters genuinely poor results into looking better than they are.`,
          `A red flag worth watching for on quality of earnings specifically: net income that's growing steadily while operating cash flow is flat or declining — this divergence can signal aggressive revenue recognition or other accounting choices that inflate reported profit without a matching increase in actual cash generated.`,
        ],
        formulas: [],
      },
      {
        id: "fsa-5f",
        title: "Module 10 — The quality spectrum: conservative to aggressive accounting",
        body: [`Financial reporting quality is best thought of as a spectrum rather than a simple pass/fail. At one end sits GAAP/IFRS-compliant reporting that is also sustainable and adequately conservative — the clear goal. Moving along the spectrum: reporting that is compliant but uses aggressive assumptions (still technically within the rules, but choosing every judgment call in a direction that flatters current results); reporting involving earnings management (deliberately timing or structuring transactions to hit a target, still nominally within accounting rules but stretching them); and, at the far end, outright fraudulent reporting that violates accounting standards entirely.`,
          `Conservative accounting tends to understate assets/income and overstate liabilities/expenses relative to economic reality (recognizing costs quickly, revenue slowly). Aggressive accounting does the reverse — overstating assets/income and understating liabilities/expenses. Neither extreme is actually desirable: conservative reporting can obscure genuine performance just as much as aggressive reporting can inflate it, and a sudden shift in a company's position along this spectrum (in either direction) is itself worth investigating, since consistent application of a stated policy is generally a better sign than sudden favorable changes.`],
        formulas: [],
      },
      {
        id: "fsa-5g",
        title: "Module 10 — Motivations and conditions for low-quality reporting",
        body: [`Several incentives can motivate management toward low-quality (or even fraudulent) financial reporting: meeting or beating analyst earnings expectations (to support the stock price), triggering management compensation tied to specific financial metrics, satisfying debt covenants (to avoid default or renegotiation), or supporting an upcoming capital raise or acquisition on more favorable terms. The "fraud triangle" framework identifies three conditions that, together, make fraudulent reporting more likely: opportunity (weak internal controls or oversight that would let manipulation go undetected), incentive/pressure (a genuine motivation to manipulate, from the list above), and rationalization (a psychological ability to justify the behavior to oneself, such as viewing it as temporary or as everyone in the industry doing the same). The presence of all three simultaneously is considered a particularly high-risk combination.`],
        formulas: [],
      },
      {
        id: "fsa-5h",
        title: "Module 10 — Mechanisms that discipline reporting quality",
        body: [`Several mechanisms exist specifically to constrain and discipline reporting quality, though each has real limitations. Market regulators (securities regulators) set and enforce reporting rules, but enforcement is retrospective — violations are typically caught and penalized only after the fact. External auditors provide independent verification, but an audit tests for material misstatement using sampling and professional judgment, not a guarantee against all forms of manipulation, and auditors are paid by the companies they audit, creating a potential (if usually well-managed) conflict of interest. Private contracting (debt covenants, compensation clawback provisions) creates direct financial consequences for poor reporting, but only for the specific parties who negotiated those contract terms. Corporate governance mechanisms (the board oversight covered in Corporate Issuers) provide internal discipline, but their effectiveness depends entirely on genuine board independence and diligence, which isn't always present in practice.`],
        formulas: [],
      },
      {
        id: "fsa-5i",
        title: "Module 10 — Presentation choices and non-GAAP measures",
        body: [`Beyond the standardized financial statements themselves, companies routinely present additional, non-standardized metrics — commonly called non-GAAP (or "adjusted") measures — such as "adjusted EBITDA" or "adjusted earnings," typically excluding items management considers non-representative of ongoing operations. These measures can genuinely aid analysis when used honestly (isolating real one-time items, as covered in Module 2), but they're also entirely at management's discretion to define, are not subject to the same audit rigor as GAAP/IFRS figures, and tend, unsurprisingly, to systematically exclude more bad items than good ones over time. An analyst's healthy habit: always reconcile a non-GAAP figure back to its nearest GAAP/IFRS equivalent (a reconciliation companies are generally required to disclose alongside the non-GAAP figure itself) before relying on it.`],
        formulas: [],
      },
      {
        id: "fsa-5j",
        title: "Module 10 — Earnings management methods and warning signs",
        body: [
          `Common accounting choices and estimates that can be used to manage earnings, cash flow, or balance sheet items include: timing revenue recognition (accelerating or delaying it around period-end to hit a target), adjusting estimates like bad debt allowances or warranty reserves (a lower estimate flatters current profit), choosing depreciation methods/useful lives favorably, and structuring transactions specifically to achieve a desired accounting outcome rather than for genuine business purposes.`,
          `Practical warning signs worth watching for: revenue growing faster than cash collected from customers, receivables or inventory growing persistently faster than sales, frequent changes in accounting policies or estimates, complex or opaque related-party transactions, heavy reliance on non-GAAP measures that consistently exclude recurring-looking items, and — a broad but useful signal — results that come in suspiciously precisely at (rather than above or below) analyst expectations, quarter after quarter. None of these alone proves manipulation, but the combination of several is a meaningful reason to dig deeper into the notes and disclosures before relying on the headline numbers.`,
        ],
        formulas: [],
      },
      {
      ...
      {
        id: "fsa-5c",
        title: "Module 11 — DuPont analysis: breaking down return on equity",
        body: [
          ...
          `Because the three drivers multiply together, changing any one of them (holding the others constant) changes ROE proportionally — a useful way to isolate exactly which lever is responsible for a period-over-period change in ROE, rather than just observing that the headline number moved.`,
        ],
        formulas: [
          { id: "fsa-5c-dupont", name: "DuPont analysis (3-factor ROE decomposition)", expression: "ROE = <span class=\"frac\"><span class=\"num\">Net income</span><span class=\"den\">Revenue</span></span> \u00D7 <span class=\"frac\"><span class=\"num\">Revenue</span><span class=\"den\">Total assets</span></span> \u00D7 <span class=\"frac\"><span class=\"num\">Total assets</span><span class=\"den\">Total equity</span></span>", when: "Breaking ROE into net profit margin \u00D7 asset turnover \u00D7 the equity multiplier (leverage), to see what's actually driving it.", problem: "A company has a 6% net profit margin, an asset turnover of 1.5, and an equity multiplier of 2.0. What is its ROE, and what's driving it?", given: ["Net profit margin = 6%", "Asset turnover = 1.5", "Equity multiplier = 2.0"], worked: "ROE = 6% \u00D7 1.5 \u00D7 2.0\nROE = 18%\n\n(a competitor could reach the same 18% ROE with only\na 4% margin and 1.0 turnover, but a 4.5 multiplier \u2014\nsame headline number, driven mostly by leverage)" },
          { id: "fsa-5c-effect", name: "Effect of a component change on ROE — advanced", expression: "New ROE = Old ROE \u00D7 <span class=\"frac\"><span class=\"num\">New component value</span><span class=\"den\">Old component value</span></span>", when: "Isolating the impact of a single DuPont driver changing, holding the other two constant.", problem: "The same company (18% ROE) increases its asset turnover from 1.5 to 1.8 next year, with margin and leverage unchanged. What is the new ROE?", given: ["Old ROE = 18%", "Old asset turnover = 1.5", "New asset turnover = 1.8"], worked: "New ROE = 18% \u00D7 (1.8 / 1.5)\nNew ROE = 18% \u00D7 1.2\nNew ROE = 21.6%\n\n(a 20% improvement in turnover flows straight\nthrough to a proportional 20% improvement in ROE)" },
        ],
      },
      {
        id: "fsa-5l",
        title: "Module 11 — Ratio relationships, industry-specific ratios, and forecasting",
        body: [
          `Ratios don't operate independently — they interact, and reading them together often reveals more than reading any one alone. A rising net profit margin paired with a falling asset turnover, for instance, might reflect a deliberate strategic shift (higher-margin, lower-volume positioning) rather than either number being "good" or "bad" on its own; evaluating a company well generally means checking whether its ratio pattern tells a coherent, plausible business story, not just checking whether each individual ratio clears some threshold.`,
          `Beyond the general-purpose ratios covered throughout this chapter, many industries have their own specialized ratios suited to that industry's specific economics — same-store sales growth for retailers, revenue per available room for hotels, or loan loss reserves as a percentage of total loans for banks. These industry-specific ratios often capture operational drivers the general-purpose ratios miss entirely, and are worth learning for any industry an analyst covers closely.`,
      ...
      {
        id: "fsa-12a",
        title: "Module 12 — Building a sales-based pro forma model",
        body: [`A pro forma model projects a company's future financial statements based on a set of assumptions, and the most common starting point is a sales-based approach: forecast revenue first (the single most important driver), then link most other line items to that revenue forecast as a percentage relationship (cost of goods sold as a percentage of revenue, based on historical or expected gross margin; operating expenses similarly scaled; working capital accounts like receivables and inventory projected using historical turnover ratios). This approach is intuitive and widely used precisely because revenue genuinely does drive most of a company's other costs — though it works best for relatively stable, mature businesses; a young company undergoing structural change may need line items modeled more independently, since historical percentage-of-sales relationships may not hold going forward.`],
        formulas: [],
      },
      {
        id: "fsa-12b",
        title: "Module 12 — Behavioral factors in analyst forecasts",
        body: [`Analyst forecasts, like most human judgment under uncertainty, are subject to systematic behavioral biases. Overconfidence leads analysts to express excessive certainty in their own forecasts, understating the true range of plausible outcomes. Anchoring causes forecasts to cling too closely to a prior estimate (the analyst's own earlier forecast, or the company's own guidance) even when new information suggests real reassessment is warranted. Confirmation bias leads analysts to seek out and weight information that supports an existing view more heavily than contradicting information. Herding leads analysts to converge toward consensus estimates, partly out of genuine information-sharing but partly out of reluctance to stand out with an unusually different forecast. Remedial actions include deliberately considering base rates and historical forecast accuracy, actively seeking out disconfirming evidence, using structured, checklist-based forecasting processes rather than relying purely on intuition, and periodically red-teaming one's own forecasts (deliberately arguing the opposing case).`],
        formulas: [],
      },
      {
        id: "fsa-12c",
        title: "Module 12 — Porter's five forces and forecasting prices and costs",
        body: [`Porter's five forces framework (the intensity of competitive rivalry, the threat of new entrants, the bargaining power of suppliers, the bargaining power of buyers, and the threat of substitute products — covered in more depth in Equity Investments) directly informs forecasting assumptions, not just qualitative industry description. An industry where all five forces are weak (limited rivalry, high barriers to entry, weak suppliers and buyers, few substitutes) generally supports forecasting sustained or even expanding margins over the forecast horizon; an industry where several forces are strong (intense rivalry, low barriers, powerful buyers) generally warrants more conservative margin assumptions, since competitive pressure tends to compress pricing power and cost advantages over time. Building this framework explicitly into a forecast — rather than simply extrapolating recent trends — helps ground projections in the underlying competitive dynamics actually driving a company's results.`],
        formulas: [],
      },
      {
        id: "fsa-12d",
        title: "Module 12 — Forecasting under price inflation or deflation",
        body: [`When forecasting industry and company sales and costs, price inflation and deflation need to be handled explicitly rather than assumed away. Forecasting sales growth often means separately estimating volume growth (more units sold) and price growth (higher price per unit, from inflation or pricing power) — a company might show strong reported revenue growth driven almost entirely by inflation-driven pricing rather than genuine volume growth, a distinction that matters enormously for assessing the sustainability of that growth once inflation moderates. On the cost side, input cost inflation needs to be forecast alongside selling price inflation — if a company's costs are rising faster than its ability to pass those increases through to customers (limited pricing power, tying back to Porter's five forces above), margins will compress even while nominal revenue and costs both rise together.`],
        formulas: [],
      },
      {
        id: "fsa-12e",
        title: "Module 12 — Choosing a forecast horizon",
        body: [`Every financial model requires choosing an explicit forecast horizon — the number of periods projected in detail before switching to a simplified terminal assumption (like a stable long-run growth rate). A longer explicit horizon can capture more of a company's expected transition toward mature, stable growth, but forecast precision genuinely degrades the further out a model projects, since the number and magnitude of unknown factors compounds with time. Common considerations in choosing a horizon: how far out the company (or industry) can be reasonably expected to reach a stable, mature growth pattern; the purpose of the analysis (a short-term trading decision needs a very different horizon than a long-term valuation); and data availability (some companies provide multi-year guidance, supporting a longer explicit horizon than one relying purely on historical extrapolation). Beyond the explicit horizon, an analyst's choices in modeling the remaining, non-explicit period typically involve simplifying assumptions — a stable perpetual growth rate, or convergence toward an industry-average return on capital — rather than continuing to forecast individual line items in the same detail used for the near-term horizon.`],
        formulas: [],
      },
      {
        id: "fsa-6",
        ...
        decisionRows: [
          ...
          { cue: "The effect of one DuPont driver changing on ROE", formula: "Component-effect DuPont formula", section: "fsa-5c" },
          { cue: "Profit restated on a per-share basis (simple structure)", formula: "Basic EPS", section: "fsa-5d" },
          { cue: "EPS assuming all convertible securities actually convert", formula: "Diluted EPS", section: "fsa-5d" },
          { cue: "Cash available to all capital providers (debt + equity)", formula: "Free cash flow to the firm (FCFF)", section: "fsa-5e" },
          { cue: "Cash available specifically to equity holders", formula: "Free cash flow to equity (FCFE)", section: "fsa-cf6" },
          { cue: "How comfortably cash flow covers interest", formula: "Cash flow coverage ratio", section: "fsa-cf6" },
          ...
          { cue: "Inventory can never be reported above this value", formula: "Net realizable value", section: "fsa-3b2" },
          ...
          { cue: "Asset's book value falls below its recoverable value", formula: "Impairment", section: "fsa-3c2" },
          { cue: "Book income and taxable income differ due to timing (reverses later)", formula: "Deferred tax asset / liability (temporary difference)", section: "fsa-3d" },
          { cue: "Book/tax difference that never reverses", formula: "Permanent difference", section: "fsa-3d" },
          { cue: "Comparing a company's real tax burden to the statutory rate", formula: "Effective tax rate", section: "fsa-3d2" },
          { cue: "Cash actually paid in taxes, vs. accrual-based tax expense", formula: "Cash tax rate", section: "fsa-3d2" },
          { cue: "Comparing companies of very different sizes", formula: "Common-size statements", section: "fsa-5b" },
          { cue: "Restating a cash flow statement line as % of revenue", formula: "Common-size cash flow statement", section: "fsa-cf5" },
          { cue: "Converting accrual revenue into cash actually collected", formula: "Direct method conversion", section: "fsa-cf3" },
          { cue: "A stock/option compensation cost with no immediate cash outlay", formula: "Stock-based compensation", section: "fsa-3e3" },
          { cue: "Reporting is honest but underlying results are weak", formula: "Reporting quality vs. quality of results", section: "fsa-5" },
          { cue: "A company hitting analyst estimates suspiciously precisely, repeatedly", formula: "Earnings management warning sign", section: "fsa-5j" },
          { cue: "\"Adjusted EBITDA\" or similar company-defined metric", formula: "Non-GAAP measure", section: "fsa-5i" },
          { cue: "Projecting revenue first, then scaling most other lines to it", formula: "Sales-based pro forma model", section: "fsa-12a" },
          { cue: "Clinging to a prior forecast despite new contrary information", formula: "Anchoring bias", section: "fsa-12b" },
        ],
        formulas: [],
      },
      {
        ...
        referenceRows: [
          ...
          { item: "Comparing ratios across very different industries", detail: "A \"normal\" ratio varies enormously by industry — always compare to peers or use industry-specific ratios where they exist." },
          ...
          { item: "Treating a deferred tax liability as money currently owed", detail: "It reflects a timing difference expected to reverse in the future, not an amount currently payable — a permanent difference, by contrast, never creates a deferred tax item at all." },
          { item: "Confusing financial reporting quality with quality of results", detail: "A company can report a genuinely bad year with perfectly high-quality, honest reporting — the two questions are distinct." },
          { item: "Trusting non-GAAP measures at face value", detail: "Always reconcile back to the nearest GAAP/IFRS figure — non-GAAP measures are management-defined and not subject to the same audit rigor." },
          { item: "Assuming diluted EPS always applies", detail: "Only companies with a complex capital structure need to report diluted EPS; an antidilutive security is excluded from the diluted calculation entirely." },
          { item: "Assuming IFRS and US GAAP cash flow statements are directly comparable", detail: "Interest and dividend classification (operating vs. financing vs. investing) can differ between the two frameworks — check before comparing headline CFO figures." },
          { item: "Forgetting the direct and indirect methods must reconcile", detail: "Both always produce the identical total operating cash flow — only the presentation of that section differs." },
          { item: "Assuming goodwill is amortized like other intangibles", detail: "Goodwill is never amortized — only tested for impairment, at least annually." },
        ],
        formulas: [],
      },
      {
  ...
  },
  {
    ...
    subtitle: "How companies decide what to invest in, and how to pay for it — 7 modules, matching the official CFA Institute outline",
    sections: [
      {
        id: "corp-1",
        title: "Overview",
        body: [`Corporate Issuers covers seven modules: how businesses are organized and owned, who their stakeholders are, corporate governance, working capital and liquidity, capital investments and allocation, capital structure, and business models. This chapter follows that same seven-module structure, and capital budgeting leans directly on the time value of money tools from Quantitative Methods.`],
        formulas: [],
      },
      {
        id: "corp-2",
        title: "Module 1 — Organizational forms of business",
        body: [`Businesses can be organized in a few basic legal forms, each with different implications for liability, taxation, and access to capital. A sole proprietorship is owned and run by one person, with no legal separation between the owner and the business — simple to set up, but the owner bears unlimited personal liability for the business's debts. A partnership is owned by two or more people who share profits, losses, and (in a general partnership) unlimited liability; a limited partnership allows some partners to have liability capped at their investment, in exchange for reduced management control. A corporation is a distinct legal entity separate from its owners (shareholders), giving owners limited liability (they can lose their investment, but no more), but subjecting the company to more regulatory requirements and, in many jurisdictions, a separate layer of corporate taxation.`],
        formulas: [],
      },
      {
        id: "corp-3",
        title: "Module 1 — Key features of corporate issuers",
        body: [`A corporation is owned by shareholders but run day-to-day by management, with a board of directors elected by shareholders to oversee management on their behalf — this separation of ownership from control is a defining feature of the corporate form, and the source of much of the governance discussion later in this chapter. Corporations can raise capital by issuing shares (equity) or by borrowing (debt, through loans or bonds), giving them access to a scale of external financing generally unavailable to sole proprietorships or partnerships. Limited liability, perpetual existence (the corporation continues regardless of any single owner's involvement), and relatively easy transferability of ownership (buying/selling shares) round out the form's defining characteristics.`],
        formulas: [],
      },
      {
        id: "corp-4",
        title: "Module 1 — Public vs. private corporate issuers",
        body: [`A publicly traded corporation has shares that trade on an open exchange, available to any investor — offering owners easy liquidity (shares can be bought/sold quickly) and access to a very large pool of potential capital, but requiring extensive public disclosure, regulatory compliance, and constant exposure to market scrutiny and short-term share-price pressure. A privately held corporation's shares are not publicly traded, typically held by a small number of owners (founders, employees, private equity or venture capital investors) — offering more operating privacy and freedom from public quarterly-earnings pressure, but with far less liquidity for owners and typically a smaller pool of available capital, usually sourced through private channels rather than public markets.`],
        formulas: [],
      },
      {
        id: "corp-5",
        title: "Module 2 — Lenders vs. shareholders: claims and motivations",
        body: [`A corporation answers to more than just its shareholders, starting with its two financial stakeholder groups. Lenders (bondholders and banks) hold a fixed, contractual claim — they're owed a specific amount regardless of how profitable the company becomes, and they're paid before shareholders in almost every circumstance, including bankruptcy; their motivation is primarily the reliable return of their principal plus interest, making them naturally more risk-averse regarding the company's decisions. Shareholders hold a residual claim instead — no guaranteed payment, but unlimited upside if the company does well; their motivation is growth in the value of their ownership stake, which can make them more tolerant of risk-taking than lenders, since the potential upside is unlimited while a lender's is capped at getting repaid.`],
        formulas: [],
      },
      {
        id: "corp-6",
        title: "Module 2 — Stakeholder groups and their interests",
        body: [`Beyond lenders and shareholders, several other groups have a real stake in a company's decisions, each with distinct interests that can sometimes conflict with one another. Employees want fair compensation, job security, and a safe working environment. Customers want reliable, high-quality products or services at a fair price. Suppliers want timely payment and a stable, ongoing business relationship. Governments and regulators want tax revenue and compliance with law. Communities want local economic contribution and responsible environmental/social conduct. Board members overseeing management sit in a unique position, formally representing shareholders' interests while, in practice, needing to weigh these other stakeholders' interests as part of sound long-term decision-making.`],
        formulas: [],
      },
      {
        id: "corp-7",
        title: "Module 2 — ESG factors considered by investors",
        body: [`Environmental, social, and governance (ESG) factors are an increasingly common lens investors use to evaluate a company beyond pure financial metrics. Environmental factors cover a company's impact on the natural environment — carbon emissions, resource use, waste and pollution management. Social factors cover a company's relationships with people — labor practices, employee treatment, product safety, and community impact. Governance factors cover how a company is run — board structure and independence, executive compensation design, shareholder rights, and business ethics (this is exactly the governance content built out in the next module). Investors incorporate ESG considerations for a range of reasons: as a genuine risk-management input (poor environmental or labor practices can create real financial and legal liabilities), as a return driver (a view that well-governed, sustainably-run companies perform better over time), or to align investment choices with values-based mandates.`],
        formulas: [],
      },
      {
        id: "corp-8",
        title: "Module 3 — The principal-agent relationship and conflicts",
        body: [`A principal-agent relationship exists whenever one party (the principal) delegates decision-making authority to another party (the agent) expected to act on the principal's behalf. The classic corporate example: shareholders (principals) delegate day-to-day decision-making to management (agents). The core problem — often called the agency problem — is that an agent's own interests don't always align with the principal's: management might prioritize its own compensation, job security, or empire-building over maximizing shareholder value, and the principal often can't fully observe or verify every decision the agent makes. Similar principal-agent conflicts can arise between other stakeholder pairs too — between shareholders and lenders (shareholders may favor riskier decisions than lenders would prefer, since shareholders capture more of the upside), and between controlling and minority shareholders (a controlling shareholder's interests may not fully align with minority shareholders' interests).`],
        formulas: [],
      },
      {
        id: "corp-9",
        title: "Module 3 — Corporate governance mechanisms",
        body: [`Corporate governance is the system of rules, practices, and oversight structures meant to manage stakeholder relationships and mitigate the agency conflicts described above. Common mechanisms include: a board of directors (particularly one with a meaningful proportion of independent directors, without material ties to management) responsible for overseeing management on shareholders' behalf; executive compensation structures designed to align management's incentives with long-term shareholder value (such as equity-based pay, vesting over multiple years, rather than purely short-term cash bonuses); shareholder voting rights (including the ability to elect/remove directors and vote on major corporate actions); external audits (independent verification of financial statements); and disclosure/transparency requirements (ensuring stakeholders have the information needed to hold management accountable in the first place).`],
        formulas: [],
      },
      {
        id: "corp-10",
        title: "Module 3 — Risks of poor governance vs. benefits of effective governance",
        body: [`Poor corporate governance and stakeholder management carry real, sometimes severe, risks: management entrenchment and self-dealing, financial misstatement or fraud (going undetected without effective oversight/audit), poor capital allocation decisions driven by management's own interests rather than shareholders', reputational damage, and — in serious cases — outright corporate failure. Effective corporate governance and stakeholder management, by contrast, tend to produce real benefits: better-aligned decision-making, lower cost of capital (investors and lenders generally demand less compensation for perceived governance risk), improved access to capital markets, and a more resilient company better able to sustain stakeholder trust and support through difficult periods.`],
        formulas: [],
      },
      {
        id: "corp-11",
        title: "Module 4 — The cash conversion cycle",
        body: [`The cash conversion cycle (CCC) measures the time it takes a company to convert its investments in inventory back into cash: how long inventory sits before being sold, plus how long it takes to collect cash from customers afterward, minus how long the company itself takes to pay its own suppliers. A shorter CCC generally means working capital is being managed more efficiently — cash is tied up for less time before cycling back to be reinvested. Comparing CCC across companies needs real care though: a shorter CCC isn't automatically "better" in isolation — a grocery retailer and an aircraft manufacturer will naturally have very different CCCs given the nature of their businesses, so meaningful comparison generally means comparing a company's CCC to its own history or to close industry peers, not across unrelated industries.`],
        exhibits: [{ afterParagraph: 0, svg: EXHIBIT_WORKED_NPV }],
        formulas: [
          { id: "corp-11-ccc", name: "Cash conversion cycle", expression: "CCC = Days inventory outstanding + Days sales outstanding \u2212 Days payables outstanding", when: "Measuring how long cash is tied up in the operating cycle before returning as cash from customers.", problem: "A company holds inventory for an average of 60 days, collects receivables in 45 days, and pays its own suppliers in 30 days. What is its cash conversion cycle?", given: ["Days inventory outstanding = 60", "Days sales outstanding = 45", "Days payables outstanding = 30"], worked: "CCC = 60 + 45 \u2212 30\nCCC = 75 days" },
        ],
      },
      {
        id: "corp-12",
        title: "Module 4 — Liquidity",
        body: [`Liquidity is a company's ability to meet its short-term (current) obligations as they come due, using cash on hand or assets that can be quickly converted to cash. It's distinct from profitability — a profitable company can still run into serious trouble if its cash is tied up in slow-paying receivables or excess inventory while bills come due now. Comparing issuers' liquidity levels typically draws on ratios like the current ratio (current assets ÷ current liabilities) and the quick ratio (a stricter version excluding inventory, since inventory is often the slowest current asset to convert to cash) — both covered in more depth in Financial Statement Analysis. As with the cash conversion cycle, meaningful liquidity comparisons work best within a similar industry, since normal liquidity levels vary a great deal by business type.`],
        formulas: [],
      },
      {
        id: "corp-13",
        title: "Module 4 — Managing working capital and liquidity",
        body: [`A company's core working capital objective is to maintain enough liquidity to operate smoothly and meet obligations, without tying up more cash than necessary in non-earning current assets. Common methods for managing this: inventory management (balancing having enough stock to meet demand against the carrying cost of excess inventory); receivables management (collecting customer payments promptly, through credit policy and collection procedures, without being so strict that it costs sales); payables management (taking full advantage of supplier payment terms without damaging the relationship or missing early-payment discounts); and short-term financing arrangements (like a revolving credit line) held in reserve specifically to smooth over temporary cash shortfalls without needing to raise longer-term capital for a short-term need.`],
        formulas: [],
      },
      {
        id: "corp-14",
        title: "Module 5 — Types of capital investments",
        body: [`Capital investments aren't all the same kind of decision, and it's useful to recognize the common categories. Going-concern investments maintain or incrementally improve existing operations (replacing worn equipment, routine capacity upgrades). Regulatory/compliance investments are required by law or regulation (environmental controls, safety upgrades) and are typically evaluated on cost-minimization rather than a standard return calculation, since they aren't optional. Expansion investments grow the business into new capacity, products, or markets, and generally carry more uncertainty (and more analysis) than going-concern spending. Other/new-venture investments are the most speculative category — genuinely new business lines or ventures with limited historical data to anchor the analysis, often evaluated with extra scenario analysis given the wider range of possible outcomes.`],
        formulas: [],
      },
      {
        id: "corp-15",
        title: "Module 5 — The capital allocation process: NPV, IRR, and ROIC",
        body: [
          `The capital allocation process is how a company decides which investment opportunities to actually fund: generating and evaluating investment ideas, estimating each one's expected cash flows, discounting them to assess value, deciding whether/how to fund the ones that clear the bar, and then monitoring performance afterward and reviewing what was learned.`,
          `Net present value (NPV) and internal rate of return (IRR) are the two most common tools for evaluating a specific proposed project in advance. NPV estimates a project's future cash flows and discounts them back to today — exactly the uneven cash flow technique from Quantitative Methods — then nets out the initial investment. IRR is the discount rate at which a project's NPV would be exactly zero; if a project's IRR exceeds the company's cost of capital, the project is generally attractive. NPV and IRR generally agree on accept/reject decisions for a single independent project, but they can rank competing, mutually exclusive projects differently (particularly with different project sizes or cash flow timing) — when NPV and IRR disagree on ranking, NPV is the theoretically preferred measure, since it directly measures value added in dollar terms rather than a percentage rate.`,
          `Return on invested capital (ROIC) offers a different, backward-looking lens: rather than evaluating a single proposed project in advance, it measures how efficiently a company has actually used the capital already invested in it — comparing ROIC to the company's cost of capital shows whether its existing investments, in aggregate, have truly been creating value or merely growing the business without necessarily creating value.`,
        ],
        formulas: [
          { id: "corp-15-npv", name: "Net present value (NPV)", expression: "NPV = (PV of future cash inflows) \u2212 (initial investment)", when: "Positive NPV = expected to add value; negative NPV = expected to destroy value.", problem: "A project costs $50,000 today and generates $15,000/year for 5 years, discounted at 10%. Is this project expected to add value?", given: ["Initial investment = $50,000", "PMT = $15,000/year", "n = 5", "r = 0.10"], worked: "PV of annuity \u2248 15,000 \u00D7 3.7908 \u2248 $56,862\n\nNPV \u2248 56,862 \u2212 50,000\nNPV \u2248 $6,862 (positive)" },
          { id: "corp-15-roic", name: "Return on invested capital (ROIC)", expression: "ROIC = <span class=\"frac\"><span class=\"num\">Net operating profit after tax</span><span class=\"den\">Invested capital</span></span>", when: "Assessing how efficiently a company's existing capital has been deployed — compare to the cost of capital to judge whether value is being created.", problem: "A company has NOPAT of $18 million and invested capital of $150 million, and a 9% cost of capital. Is the company creating value with its existing capital?", given: ["NOPAT = $18M", "Invested capital = $150M", "Cost of capital = 9% (for comparison)"], worked: "ROIC = 18 / 150\nROIC = 12%\n\n(above the 9% cost of capital \u2014 genuinely\ncreating value with existing capital)" },
        ],
      },
      {
        id: "corp-16",
        title: "Module 5 — Principles and pitfalls of capital allocation",
        body: [`Sound capital allocation follows a few core principles: use cash flows, not accounting earnings (accounting profit can be manipulated by non-cash items and timing choices; cash flow is harder to distort); use incremental cash flows only (the cash flows that actually change because the project is undertaken, not the company's total cash flows); ignore sunk costs (money already spent, and unrecoverable, regardless of the decision made now); and include opportunity costs (the value of the next-best alternative use of the resources being committed) and any side/externality effects on other parts of the business (a new product cannibalizing an existing one's sales, for example). Common pitfalls include: basing decisions on earnings per share or accounting profit impact rather than genuine cash-flow value creation; failing to adjust for a project's specific risk level (using the company's overall cost of capital for a much riskier-than-usual project); and conflicts of interest, where the people proposing or evaluating a project have their own incentives (career, empire-building, personal metrics) not fully aligned with genuinely maximizing shareholder value.`],
        formulas: [],
      },
      {
        id: "corp-17",
        title: "Module 5 — Real options in capital investments",
        body: [`Beyond the immediate cash flows, many capital investments come with embedded real options — genuine decision flexibility that adds value beyond a simple, static NPV calculation, since management can adapt as new information arrives. A timing option is the ability to delay a project until more information is available. An abandonment option is the ability to shut down or exit a project early if it's performing poorly, limiting the downside. An expansion option is the ability to scale up a project if it performs well, capturing more upside than a fixed, one-time decision would allow. A flexibility option (such as the ability to switch inputs, outputs, or processes) allows a project to adapt to changing conditions after launch. Because these options only add value and are never required to be exercised, projects with meaningful embedded real options are generally worth somewhat more than a bare NPV calculation alone would suggest.`],
        formulas: [],
      },
      {
        id: "corp-18",
        title: "Module 6 — Weighted average cost of capital (WACC)",
        body: [`A company's cost of capital is the blended rate of return it must earn to satisfy both its lenders and its shareholders — the minimum bar any new project must clear, and the discount rate typically used in the NPV calculations from the prior module. This blended figure is the weighted average cost of capital (WACC): the cost of each financing source (debt and equity), weighted by its proportion of the company's total capital, with the after-tax cost of debt used specifically because interest is generally tax-deductible (creating the tax shield discussed in the Modigliani-Miller propositions below).`],
        formulas: [
          { id: "corp-18-wacc", name: "Weighted average cost of capital (WACC)", expression: "WACC = (E/V \u00D7 Re) + (D/V \u00D7 Rd \u00D7 (1\u2212Tax rate))", when: "Finding the blended minimum required return a company must earn across all its financing sources.", problem: "A company has $600M of equity and $400M of debt, a 12% cost of equity, a 6% cost of debt, and a 25% tax rate. What is its WACC?", given: ["Market value of equity (E) = $600M", "Market value of debt (D) = $400M", "V = E+D = $1,000M", "Cost of equity (Re) = 12%", "Cost of debt (Rd) = 6%", "Tax rate = 0.25"], worked: "WACC = (600/1,000 \u00D7 12%) + (400/1,000 \u00D7 6% \u00D7 (1\u22120.25))\nWACC = (0.6 \u00D7 12%) + (0.4 \u00D7 6% \u00D7 0.75)\nWACC = 7.2% + 1.8%\nWACC = 9.0%" },
        ],
      },
      {
        id: "corp-19",
        title: "Module 6 — Factors affecting capital structure and WACC",
        body: [`Several factors shape both a company's chosen capital structure and its resulting WACC. Business risk (how volatile the company's own operating cash flows are) tends to push riskier businesses toward less debt, since a volatile business layered with fixed debt payments raises financial distress risk. Tax rates affect the size of the interest tax shield — a higher corporate tax rate makes debt financing more attractive, all else equal. Financial market conditions affect the relative cost and availability of debt versus equity financing at any given time. Management's own preferences and a company's specific growth stage matter too — young, high-growth companies with uncertain cash flows often rely more heavily on equity, while stable, mature companies with predictable cash flows can typically support more debt.`],
        formulas: [],
      },
      {
        id: "corp-20",
        title: "Module 6 — The Modigliani-Miller propositions",
        body: [`The Modigliani-Miller propositions are the foundational theory behind the capital structure trade-off. In their simplest form (ignoring taxes and other real-world frictions), Modigliani and Miller showed that a company's capital structure shouldn't affect its total value at all — the pie is the same size regardless of how it's sliced between debt and equity. Once taxes are introduced, though, the picture changes: interest payments on debt are typically tax-deductible, creating a genuine tax benefit to using debt (an "interest tax shield") that pure equity financing doesn't offer — which is part of why real companies do usually carry some debt.`],
        formulas: [],
      },
      {
        id: "corp-21",
        title: "Module 6 — Optimal and target capital structures",
        body: [`An optimal capital structure is the mix of debt and equity that minimizes a company's WACC (and, correspondingly, maximizes its overall value), balancing the tax benefit of debt against the rising costs of financial distress as leverage increases — beyond some point, additional debt raises the risk of default and financial distress enough that it outweighs the further tax savings, pushing WACC back up rather than down. In practice, companies typically don't recalculate a precise optimum continuously; instead they set a target capital structure — a desired long-run mix of debt and equity — and gradually manage actual financing decisions toward that target over time, rather than requiring every individual decision to sit exactly on it.`],
        formulas: [],
      },
      {
        id: "corp-22",
        title: "Module 7 — Key features of business models",
        body: [`A business model describes, at a fundamental level, how a company creates, delivers, and captures value — what it sells, to whom, and how it actually earns money from that activity. Key features worth identifying in any business model include: the value proposition (what customer problem is being solved, and why this company's solution over alternatives), the revenue model (how the company actually gets paid — one-time sale, subscription, transaction fee, advertising, and so on), the cost structure (which costs are fixed versus variable, and how that shapes the company's operating leverage), and the target customer/market. Understanding a company's business model is a necessary first step before any of the deeper valuation or financial analysis covered elsewhere in this course actually makes sense, since the same financial ratio can mean very different things depending on the underlying business generating it.`],
        formulas: [],
      },
      {
        id: "corp-23",
        title: "Module 7 — Types of business models",
        body: [`Common business model types include: a traditional product-sales model (selling a physical or digital good outright, one transaction at a time); a subscription model (recurring revenue in exchange for ongoing access, often producing more predictable revenue than one-time sales); a marketplace/platform model (connecting buyers and sellers, or two distinct user groups, and earning a fee or commission on the transactions or interactions between them, rather than owning the underlying inventory itself); an advertising-supported model (offering a product or service free or cheap to users, and monetizing through advertisers instead); and a franchise model (licensing a proven business format to independent operators in exchange for fees and ongoing royalties). A single company can also blend more than one of these — many real businesses layer a primary revenue model with a secondary one (a subscription streaming service that also sells advertising, for instance) — and recognizing which blend applies is part of correctly interpreting that company's financial statements later on.`],
        formulas: [],
      },
      {
        id: "corp-24",
        ...
        body: [`Match the question to the concept.`],
        decisionRows: [
          { cue: "Comparing sole proprietorship, partnership, and corporation", formula: "Organizational forms of business", section: "corp-2" },
          { cue: "Shares trading on an open exchange vs. held privately", formula: "Public vs. private corporate issuers", section: "corp-4" },
          { cue: "Comparing a lender's claim to a shareholder's claim", formula: "Lenders vs. shareholders", section: "corp-5" },
          { cue: "Environmental, social, and governance factors", formula: "ESG factors", section: "corp-7" },
          { cue: "One party delegating decisions to another whose interests may differ", formula: "Principal-agent relationship", section: "corp-8" },
          { cue: "Board independence, exec compensation design, audits", formula: "Corporate governance mechanisms", section: "corp-9" },
          { cue: "How long cash is tied up in the operating cycle", formula: "Cash conversion cycle", section: "corp-11" },
          { cue: "Ability to meet short-term obligations", formula: "Liquidity", section: "corp-12" },
          { cue: "A project required by law, evaluated on cost-minimization", formula: "Regulatory/compliance investment", section: "corp-14" },
          { cue: "Whether a project adds value in dollar terms", formula: "NPV", section: "corp-15" },
          { cue: "The project's own break-even rate of return", formula: "IRR", section: "corp-15" },
          { cue: "How efficiently existing invested capital has been used", formula: "ROIC (vs. cost of capital)", section: "corp-15" },
          { cue: "Ignoring money already spent, regardless of the decision now", formula: "Sunk cost principle", section: "corp-16" },
          { cue: "The ability to delay, expand, or abandon a project", formula: "Real options", section: "corp-17" },
          { cue: "The minimum blended return a company must earn overall", formula: "WACC", section: "corp-18" },
          { cue: "Whether capital structure itself affects total firm value", formula: "Modigliani-Miller propositions", section: "corp-20" },
          { cue: "The desired long-run mix of debt and equity", formula: "Target capital structure", section: "corp-21" },
          { cue: "How a company creates, delivers, and captures value", formula: "Business model features", section: "corp-22" },
          { cue: "Subscription, marketplace, advertising-supported, franchise", formula: "Types of business models", section: "corp-23" },
        ],
        formulas: [],
      },
      {
        ...
        body: [`Watch for these.`],
        referenceRows: [
          { item: "Accepting a project just because IRR is \"high\"", detail: "Always compare IRR to the cost of capital — NPV handles scale trade-offs more directly, especially for mutually exclusive projects." },
          ...
          { item: "Confusing sole proprietorship/partnership liability with corporate liability", detail: "Only the corporate form gives owners limited liability; sole proprietors and general partners face unlimited personal liability." },
          { item: "Assuming ESG is purely a values-based consideration", detail: "Investors also incorporate ESG factors as a risk-management and return-driver input, not only for values alignment." },
          { item: "Treating the agency problem as unique to shareholders vs. management", detail: "Principal-agent conflicts can also arise between shareholders and lenders, or between controlling and minority shareholders." },
          { item: "Comparing CCC or liquidity ratios across unrelated industries", detail: "Meaningful comparison works best against a company's own history or close industry peers, given how much normal levels vary by business type." },
          { item: "Using WACC as the discount rate for every project regardless of risk", detail: "A project with different risk than the company's typical operations should be discounted at a rate reflecting its own risk, not the firm's overall WACC." },
        ],
        formulas: [],
      },
    ],
  },
  {
    ...
    subtitle: "How stocks are structured, traded, valued, and researched — 12 modules, matching the official CFA Institute outline",
    sections: [
      {
        id: "equity-1",
        title: "Overview",
        body: [`Equity Investments spans twelve modules: instrument features, jurisdictions/classes/voting, issuance and trading, sources of return, an introduction to valuation, discounted cash flow and growth models, relative valuation, financial statement forecasting, industry analysis, company analysis, research reports, and factor-based models like CAPM. This chapter follows that same twelve-module structure directly.`],
        formulas: [],
      },
      {
        id: "equity-1b",
        title: "Module 1 — Basic features and types of equity instruments",
        body: [
          `Common stock represents residual ownership: common shareholders are paid last (after every other claimant, including preferred shareholders), but typically have voting rights and unlimited upside if the company does well.`,
          `Preferred stock typically pays a fixed dividend and is paid before common shareholders, but usually carries no voting rights and limited upside — a hybrid between a bond and common stock. Preferred stock itself comes in variants: cumulative preferred (unpaid dividends accumulate and must be paid before any common dividend) versus non-cumulative (skipped dividends are simply lost), and convertible preferred (can be converted into common shares under specified conditions, bundling in some of common stock's upside potential) versus non-convertible.`,
        ],
        formulas: [],
      },
      {
        id: "equity-1c",
        title: "Module 1 — Public vs. private equity securities",
        body: [`Publicly traded equity trades on an open exchange, available to any investor — offering owners easy liquidity (shares can be bought/sold quickly) and access to a very large pool of potential capital, but requiring extensive public disclosure, regulatory compliance, and constant exposure to market scrutiny and short-term share-price pressure. Privately held equity is not publicly traded, typically held by a small number of owners (founders, employees, private equity or venture capital investors) — offering more operating privacy and freedom from public quarterly-earnings pressure, but with far less liquidity for owners, a smaller pool of available capital sourced through private channels, and generally more limited, negotiated information disclosure (rather than the standardized public filings covered in Financial Statement Analysis) available to any given investor.`],
        formulas: [],
      },
      {
        id: "equity-2",
        title: "Module 2 — Economic and voting rights across jurisdictions and share classes",
        body: [`Not every share of common stock carries identical rights, even within the same company. Companies sometimes issue multiple share classes with different voting power per share (a common structure lets founders retain outsized control through a high-vote class while public investors hold a lower-vote or non-voting class) — meaningful for valuation, since two classes with identical economic (cash flow) rights can trade at different prices purely due to differing voting power. Economic and voting rights also vary meaningfully by jurisdiction: some markets mandate one-share-one-vote structures, while others permit dual-class structures, differing minority shareholder protections, or differing thresholds for shareholder approval on major corporate actions — an analyst comparing companies across countries needs to check these structural differences rather than assuming uniform shareholder rights globally.`],
        formulas: [],
      },
      {
        id: "equity-2b",
        title: "Module 2 — The voting process and its participants",
        body: [`Shareholder voting typically happens at an annual (or special) general meeting, where shareholders elect directors and vote on major proposals. Since most shareholders don't attend in person, proxy voting lets them authorize someone else (often management's own nominated slate, or an independent party) to cast their vote on their behalf — the standard mechanism through which most retail shareholder votes are actually exercised. Several parties shape this process: the issuer's management proposes the matters to be voted on and typically recommends how to vote; the board of directors oversees the process and is itself subject to election by shareholders; proxy advisors (independent firms) research proposals and issue voting recommendations that many institutional investors follow closely, giving them outsized practical influence; asset managers vote the shares they hold on behalf of their underlying clients, based on their own voting policies; and asset owners (pension funds, endowments, individual investors) are the ultimate beneficial owners whose interests the whole chain is meant to serve, though they often have limited direct visibility into how their shares are actually voted by the asset managers holding them.`],
        formulas: [],
      },
      {
        id: "equity-3",
        title: "Module 3 — Primary and secondary equity markets",
        body: [`The primary market is where a company raises capital by initially issuing new shares directly to investors — most visibly through an initial public offering (IPO), the first time a company's shares become publicly available, but also through later follow-on offerings. Proceeds from a primary market transaction go to the issuing company itself. The secondary market is where investors trade existing shares among themselves after issuance — a stock exchange's day-to-day trading is entirely secondary market activity, and proceeds go to the selling shareholder, not the company. The secondary market's core function is providing liquidity and continuous price discovery, which in turn makes the primary market viable in the first place — investors are far more willing to buy newly issued shares knowing an active secondary market exists to exit that position later.`],
        formulas: [],
      },
      {
        id: "equity-3b",
        title: "Module 3 — Exchange, off-exchange, and OTC trading",
        body: [`Exchange trading happens on a formal, organized exchange (like the NYSE), with centralized order matching, price transparency, and standardized listing requirements companies must meet and maintain. Over-the-counter (OTC) trading happens through a decentralized dealer network rather than a centralized exchange — dealers post bid/ask quotes and trade directly with counterparties, common for smaller or less liquid companies that don't meet full exchange listing requirements. Off-exchange trading more broadly includes OTC trading but also covers other venues like dark pools (private trading venues that don't publicly display quotes before execution, often used by large institutional investors specifically to avoid moving the market price with a large order) and other alternative trading systems. Each venue type trades off transparency and price discovery quality against execution flexibility and, for off-exchange venues, reduced market impact for large trades.`],
        formulas: [],
      },
      {
        id: "equity-3c",
        title: "Module 3 — Liquidity measures: float and average daily volume",
        body: [`Two straightforward, widely used measures give a quick read on a stock's liquidity. Float is the number of shares actually available for public trading — total shares outstanding minus shares held by insiders, controlling shareholders, or otherwise restricted from trading, since those shares don't meaningfully contribute to trading liquidity even though they count toward the company's total share count. Average daily volume is simply the average number of shares traded per day over some recent period, giving a sense of how easily a given position size could be bought or sold without materially moving the price — a position representing several days' worth of average volume is considerably harder to exit quickly than one representing a small fraction of a single day's typical trading.`],
        formulas: [
          { id: "equity-3c-float", name: "Float", expression: "Float = Total shares outstanding \u2212 Restricted/insider-held shares", when: "Measuring how many shares are actually available for public trading.", problem: "A company has 50,000,000 total shares outstanding, of which insiders and the founding family hold 18,000,000 shares that are restricted from public trading. What is the company's float?", given: ["Total shares outstanding = 50,000,000", "Restricted/insider-held shares = 18,000,000"], worked: "Float = 50,000,000 \u2212 18,000,000\nFloat = 32,000,000 shares" },
          { id: "equity-3c-adv", name: "Average daily volume", expression: "ADV = <span class=\"frac\"><span class=\"num\">Total shares traded over the period</span><span class=\"den\">Number of trading days in the period</span></span>", when: "Estimating how easily a position could be bought or sold without materially moving the price.", problem: "Over the last 20 trading days, a stock traded a total of 6,000,000 shares. What is its average daily volume?", given: ["Total shares traded = 6,000,000", "Trading days = 20"], worked: "ADV = 6,000,000 / 20\nADV = 300,000 shares/day" },
        ],
      },
      {
        id: "equity-3d",
        title: "Module 3 — Types of equity indexes",
        body: [`A stock market index tracks the combined performance of a specified basket of securities. How an index weights its constituents meaningfully changes what it measures: a price-weighted index (like the Dow Jones Industrial Average) simply averages constituent prices, so a higher-priced stock moves the index more regardless of company size; a market-capitalization-weighted index (like the S&P 500) weights each constituent by total market value, so larger companies drive more of the index's movement — generally considered more representative of the aggregate market; and an equal-weighted index gives every constituent identical weight regardless of price or size, tilting more toward smaller companies than either of the other two methods. This same weighting logic was covered in depth, with a worked example, in the Returns & Benchmarking chapter.`],
        formulas: [],
      },
      {
        id: "equity-3h",
        ...
        formulas: [
          { id: "equity-3h-margin", name: "Margin call price", expression: "Margin call price = Purchase price \u00D7 <span class=\"frac\"><span class=\"num\">1 \u2212 Initial margin</span><span class=\"den\">1 \u2212 Maintenance margin</span></span>", when: "Finding the stock price at which a margin call will be triggered.", problem: "An investor buys a stock at $80/share using 60% initial margin, with a 30% maintenance margin requirement. At what price will a margin call be triggered?", given: ["Purchase price = $80", "Initial margin = 0.60", "Maintenance margin = 0.30"], worked: "Margin call price = 80 \u00D7 [(1\u22120.60)/(1\u22120.30)]\nMargin call price = 80 \u00D7 (0.40/0.70)\nMargin call price \u2248 $45.71" },
        ],
      },
      {
        id: "equity-3e",
        title: "Module 4 — Dividends, share repurchases, and stock splits",
        body: [
          `Companies return cash to shareholders in a few distinct ways. Cash dividends are direct, typically recurring cash payments to shareholders — a visible, hard-to-cut-without-signal commitment, which is exactly why dividend cuts are often read by the market as a strongly negative signal about a company's outlook.`,
          `Share repurchases (buybacks) have the company buy back its own shares on the open market, reducing shares outstanding — this increases each remaining share's proportional ownership and, all else equal, boosts earnings per share, without the same "recurring commitment" signal a dividend carries, since buybacks can be scaled up or down more flexibly period to period.`,
          `A stock split increases the number of shares outstanding while proportionally reducing the price per share (a 2-for-1 split turns one $100 share into two $50 shares) — purely cosmetic in terms of total value, but sometimes used to bring a high per-share price back into a range perceived as more accessible to retail investors. A reverse stock split does the opposite, reducing share count and proportionally raising price per share — often used by a company whose price has fallen low enough to risk exchange delisting, or to project a more "premium" per-share price.`,
        ],
        formulas: [],
      },
      {
        id: "equity-3f",
        title: "Module 4 — Dividend payment chronology",
        body: [`A dividend moves through a fixed sequence of dates. The declaration date is when the board formally announces the dividend, amount, and upcoming dates. The ex-dividend date is the first date a share trades without the right to the upcoming dividend — an investor who buys on or after this date will not receive the declared dividend; buying before it does. The record date (typically shortly after the ex-dividend date, to allow for settlement) is when the company checks its records to determine exactly who is owed the dividend. The payment date is when the cash actually gets paid out to those shareholders of record. Since a stock's price typically drops by roughly the dividend amount on the ex-dividend date (the buyer is no longer entitled to that cash), this sequence has real, practical trading and pricing implications, not just administrative bookkeeping.`],
        formulas: [],
      },
      {
        id: "equity-3g",
        title: "Module 4 — Price return and total return",
        body: [`Price return captures only the change in a stock's price, ignoring any income received — useful for isolating pure capital appreciation, but incomplete on its own. Total return (the same holding period return concept introduced in Quantitative Methods) captures the full picture: price appreciation plus any dividends received, together. For a dividend-paying stock, relying on price return alone can meaningfully understate the investor's actual realized return.`],
        formulas: [
          { id: "equity-3g-price", name: "Price return", expression: "Price return = <span class=\"frac\"><span class=\"num\">Ending price \u2212 Beginning price</span><span class=\"den\">Beginning price</span></span>", when: "Measuring pure price appreciation, ignoring any dividend income.", problem: "A stock begins the year at $40 and ends the year at $46, with no dividends paid. What is its price return?", given: ["Beginning price = $40", "Ending price = $46"], worked: "Price return = (46 \u2212 40) / 40\nPrice return = 6/40\nPrice return = 15%" },
          { id: "equity-3g-total", name: "Total return", expression: "Total return = <span class=\"frac\"><span class=\"num\">Ending price \u2212 Beginning price + Dividends received</span><span class=\"den\">Beginning price</span></span>", when: "Measuring the full return earned, including both price appreciation and dividend income.", problem: "The same stock begins the year at $40, ends at $46, and paid $1.50 in dividends during the year. What is the total return?", given: ["Beginning price = $40", "Ending price = $46", "Dividends received = $1.50"], worked: "Total return = (46 \u2212 40 + 1.50) / 40\nTotal return = 7.50 / 40\nTotal return = 18.75%\n\n(nearly 4 percentage points higher than the 15%\nprice return alone \u2014 the dividend meaningfully\nadds to the investor's actual realized return)" },
        ],
      },
      {
        id: "equity-5intro",
        title: "Module 5 — Price vs. value",
        body: [`Price is simply what a stock currently trades for in the market — an observable fact. Value (or intrinsic value) is an analyst's estimate of what a stock is actually worth, based on its underlying fundamentals — an opinion, however well-researched. The entire purpose of equity valuation is comparing the two: if estimated intrinsic value exceeds the current market price, the stock appears undervalued (a buy candidate, under this framework); if intrinsic value is below the current price, the stock appears overvalued. This comparison is only as good as the valuation model and assumptions behind the "value" side of it — a theme that resurfaces throughout the rest of this chapter.`],
        formulas: [],
      },
      {
        id: "equity-5intro2",
        title: "Module 5 — Book value, market capitalization, and enterprise value",
        body: [`Three distinct figures are sometimes loosely (and incorrectly) used interchangeably as indicators of a company's value, but each measures something different. Book value of equity is an accounting figure — total assets minus total liabilities, as recorded on the balance sheet — reflecting historical cost accounting rather than current market value, and often a poor proxy for economic value, especially for asset-light or intangible-heavy businesses (the intangibles gap covered in Financial Statement Analysis). Market capitalization is the current market's collective valuation of the company's equity — share price times shares outstanding — reflecting the market's forward-looking view rather than historical cost, but excludes the company's debt entirely. Enterprise value goes further, capturing the total value of the underlying business regardless of how it's financed — market cap plus total debt minus cash — making it the more appropriate figure for comparing companies with different capital structures, and the basis for the enterprise-value multiples covered later in this chapter.`],
        formulas: [],
      },
      {
        id: "equity-5intro3",
        title: "Module 5 — Categories of equity valuation models",
        body: [`Equity valuation models fall into three broad categories, each with real trade-offs. Present value (discounted cash flow) models estimate value as the present value of expected future cash flows — theoretically the most rigorous approach, since it directly ties value to the cash an investor actually expects to receive, but highly sensitive to the specific growth and discount rate assumptions used, and requires forecasting far into the future. Relative valuation (multiples-based) models estimate value by comparing a company to similar peers using a ratio like P/E — simpler and grounded in observable market prices, but only as good as the comparability of the chosen peer group, and can simply reflect the whole peer group being over- or under-valued together. Asset-based models estimate value from the underlying value of a company's net assets — most useful for asset-heavy businesses (real estate, natural resources) or in liquidation scenarios, but poorly suited to asset-light, intangible-driven businesses where most of the value isn't captured on the balance sheet at all.`],
        formulas: [],
      },
      {
        id: "equity-6a",
        title: "Module 6 — Comparing DCF model inputs: DDM, FCFE, FCFF, and residual income",
        body: [
          `Several present value model variants exist, differing mainly in which cash flow stream they discount, and each best suited to different situations.`,
          `The dividend discount model (DDM) discounts expected future dividends — the most direct claim a common shareholder actually receives, but a poor fit for companies that pay small or no dividends despite genuine cash-generating capacity.`,
          `Free cash flow to equity (FCFE), covered in Financial Statement Analysis, discounts cash that *could* be paid to equity holders, regardless of whether it's actually paid out as dividends — a better fit than DDM for non-dividend-paying but cash-generative companies.`,
          `Free cash flow to the firm (FCFF), also covered in Financial Statement Analysis, discounts cash available to all capital providers (debt and equity combined), then subtracts the value of debt claims to arrive at equity value — often preferred when a company's capital structure or debt level is expected to change significantly, since FCFF is less directly distorted by financing decisions than FCFE is.`,
          `The residual income model takes a different approach entirely: rather than discounting a cash flow stream, it starts from book value of equity and adds the present value of expected future residual income — the amount by which a company's earnings exceed (or fall short of) the return required on its book equity capital. This model has a notable practical advantage: since it starts from an already-known figure (current book value) rather than needing to forecast an entire future cash flow stream from scratch, a larger portion of estimated value is anchored in current, observable data rather than distant, uncertain projections — making it comparatively less sensitive to terminal value assumptions than a pure DCF approach.`,
          `Across all of these present value approaches, the general process is the same: forecast the relevant cash flow (or residual income) stream, discount each period back to today at an appropriate required rate of return, and sum the results — the same fundamental time value of money logic from Quantitative Methods, just applied to a stream that extends indefinitely into the future rather than a fixed number of periods.`,
        ],
        formulas: [],
      },
      {
        id: "equity-4",
        title: "Module 6 — The dividend discount model: constant growth",
        body: [`If a company pays dividends, its shares can be valued using the exact same growing perpetuity logic from Quantitative Methods — a share of stock is just a claim on a stream of future dividends, discounted back to today.`],
        exhibits: [{ afterParagraph: 0, svg: EXHIBIT_WORKED_DDM }],
        formulas: [
          { id: "equity-4-ggm", name: "Gordon growth (constant-growth dividend discount) model", expression: "V0 = <span class=\"frac\"><span class=\"num\">D1</span><span class=\"den\">r \u2212 g</span></span>", when: "Values a stock as a growing perpetuity of dividends.", problem: "A stock just paid a $2.00 dividend, growing 4% per year forever, at a 10% required return. What is the stock worth today?", given: ["D0 = $2.00 (just paid)", "g = 0.04", "r = 0.10"], worked: "D1 = 2.00 \u00D7 1.04 = $2.08\n\nV0 = 2.08 / (0.10 \u2212 0.04)\nV0 \u2248 $34.67" },
        ],
      },
      {
        id: "equity-4b",
        title: "Module 6 — Multistage growth models",
        body: [`Not every company grows at one constant rate forever — the single-stage Gordon growth model breaks down whenever growth is expected to shift meaningfully, such as a fast-growing young company expected to slow to a stable, mature growth rate later on. A two-stage (multistage) dividend discount model handles this by valuing the high-growth years individually (as an uneven cash flow series, the same technique from Quantitative Methods), then valuing everything after that as a Gordon growth perpetuity (the terminal value), and finally discounting that terminal value back to today alongside the individual early-year dividends.`],
        formulas: [
          { id: "equity-4b-twostage", name: "Two-stage dividend discount model — advanced", expression: "V0 = <span class=\"frac\"><span class=\"num\">D1</span><span class=\"den\">(1+r)<sup>1</sup></span></span> + <span class=\"frac\"><span class=\"num\">D2</span><span class=\"den\">(1+r)<sup>2</sup></span></span> + <span class=\"frac\"><span class=\"num\">Terminal value</span><span class=\"den\">(1+r)<sup>2</sup></span></span>, where Terminal value = D3 / (r\u2212gstable)", when: "Valuing a company expected to grow quickly for a few years before settling into stable, long-run growth.", problem: "A company just paid a $1.00 dividend, expected to grow 20% for the next 2 years, then settle into 4% stable growth forever. The required return is 11%. What is the stock worth today?", given: ["D0 = $1.00", "High growth = 20% for years 1-2", "Stable growth (year 3 onward) = 4%", "r = 0.11"], worked: "D1 = 1.00 \u00D7 1.20 = $1.20\nD2 = 1.20 \u00D7 1.20 = $1.44\nD3 = 1.44 \u00D7 1.04 = $1.4976\n\nTerminal value (end of yr 2) = 1.4976 / (0.11\u22120.04) \u2248 $21.39\n\nV0 = 1.20/(1.11)^1 + 1.44/(1.11)^2 + 21.39/(1.11)^2\nV0 \u2248 1.08 + 1.17 + 17.36\nV0 \u2248 $19.61" },
        ],
      },
      {
        id: "equity-6b",
        title: "Module 6 — Shortcomings of growth model assumptions",
        body: [`Both the constant-growth and multistage growth models rest on assumptions that can meaningfully distort the resulting valuation if they don't hold up. The constant-growth (Gordon growth) model assumes a single, perpetual growth rate forever — unrealistic for almost any real company over a truly infinite horizon, and mathematically undefined or nonsensical if growth is assumed to equal or exceed the required return. It's also extremely sensitive to small changes in either input: a small change in the assumed growth rate or required return can swing the resulting value dramatically, since both sit in the denominator's difference. Multistage models relax the single-growth-rate assumption but introduce their own issue: the terminal value (capturing all cash flows beyond the explicit forecast period) is itself typically a Gordon-growth calculation, so it inherits the same sensitivity, and it often represents the large majority of the total estimated value — meaning the model's overall output can be dominated by a single, distant, hard-to-verify assumption about stable long-run growth, more than by the detailed near-term forecast the model appears to emphasize.`],
        formulas: [],
      },
      {
        id: "equity-6c",
        title: "Module 6 — Valuing preferred stock",
        body: [`A non-callable, non-convertible preferred stock that pays a level, perpetual dividend is valued using the exact same level perpetuity formula from Quantitative Methods — since a fixed, non-growing, never-ending dividend stream is precisely what a level perpetuity discounts. Contingency features change this: a callable preferred stock (the issuer can redeem it early) caps the upside an investor should expect, similar to a callable bond, since the issuer is likely to call it away exactly when market rates have fallen and the fixed dividend has become attractive — pushing intrinsic value estimates below what the pure perpetuity formula alone would suggest. A convertible preferred stock (convertible into common shares) adds value beyond the plain perpetuity calculation, since it bundles in some of common stock's upside potential — its value is better estimated as the greater of its value as a straight (non-convertible) preferred, or the value of the common shares it could convert into.`],
        formulas: [
          { id: "equity-6c-pref", name: "Value of a non-callable, non-convertible preferred stock", expression: "V0 = <span class=\"frac\"><span class=\"num\">Preferred dividend</span><span class=\"den\">r</span></span>", when: "Valuing a level, perpetual preferred dividend stream with no embedded options.", problem: "A preferred stock pays a $4.50 annual dividend forever, and the required return on preferred stock of this risk level is 7%. What is it worth?", given: ["Preferred dividend = $4.50", "r = 0.07"], worked: "V0 = 4.50 / 0.07\nV0 \u2248 $64.29" },
        ],
      },
      {
        id: "equity-7intro",
        title: "Module 7 — Methods for using multiples: comparables vs. forecasted fundamentals",
        body: [`Multiples can be used two distinct ways. The method of comparables values a company by comparing its multiple (P/E, EV/EBITDA, and similar) to the multiples of similar peer companies, or to that same company's own historical multiple range — the target company's fair multiple is inferred from what similar things currently trade for. The method of forecasted fundamentals instead builds a multiple up from first principles, deriving what a company's multiple *should* be based on its own underlying fundamentals (its expected growth rate, profitability, and risk) — for example, the Gordon growth model can be algebraically rearranged to show that a company's justified P/E ratio depends directly on its payout ratio, required return, and growth rate. The comparables method is faster and grounded in real market prices, but only as good as how genuinely comparable the chosen peers are; the fundamentals method is more theoretically rigorous, but requires the same kind of growth and risk forecasts that make discounted cash flow models sensitive to their assumptions in the first place.`],
        formulas: [],
      },
      {
        id: "equity-5",
        title: "Module 7 — Price and enterprise value multiples",
        body: [`Rather than discounting cash flows directly, analysts often value a stock by comparing it to similar companies using a multiple — a ratio of price (or enterprise value) to some fundamental metric. Appropriate use depends on the situation: price-based multiples like P/E are simple and widely used, but are distorted by differences in capital structure/leverage across companies; enterprise-value multiples like EV/EBITDA sidestep that distortion, at the cost of being somewhat more complex to calculate.`],
        formulas: [
          { id: "equity-5-pe", name: "Price-to-earnings (P/E) ratio", expression: "<span class=\"frac\"><span class=\"num\">Price per share</span><span class=\"den\">Earnings per share</span></span>", when: "Comparing a stock's price to its earnings, relative to similar companies.", problem: "A stock trades at $60 with earnings per share of $4.00. What is its P/E ratio?", given: ["Price = $60", "EPS = $4.00"], worked: "P/E = 60 / 4\nP/E = 15" },
          { id: "equity-5-ev", name: "Enterprise value multiple — advanced", expression: "EV/EBITDA = <span class=\"frac\"><span class=\"num\">Enterprise value</span><span class=\"den\">EBITDA</span></span>", when: "Comparing companies with very different capital structures (debt levels), since enterprise value captures both debt and equity claims, sidestepping the leverage differences that can distort a pure equity-price-based multiple like P/E.", problem: "A company has a market cap of $800 million, total debt of $300 million, cash of $100 million, and EBITDA of $125 million. What is its EV/EBITDA multiple?", given: ["Market cap = $800M", "Total debt = $300M", "Cash = $100M", "EBITDA = $125M"], worked: "EV = 800 + 300 \u2212 100 = $1,000M\n\nEV/EBITDA = 1,000 / 125\nEV/EBITDA = 8.0" },
        ],
      },
      {
        id: "equity-7b",
        title: "Module 7 — Determining a peer group",
        body: [`Choosing a good peer group is the single most important — and most judgment-dependent — step in comparables-based valuation. Two broad approaches: grouping by industry classification (companies formally categorized in the same industry/sector, using standardized classification systems covered later in this chapter) — straightforward and consistent, but can lump together companies that don't actually share similar economics (a diversified conglomerate assigned to one industry code isn't truly comparable to a pure-play competitor within it); or grouping by specific drivers of expected return — companies that may sit in different official industry categories but share similar growth rates, margins, risk profiles, or business models. The second approach is more analytically defensible but requires more judgment, since there's no standardized list to simply pull from — an analyst has to justify why the chosen peers are genuinely comparable on the dimensions that actually matter for valuation.`],
        formulas: [],
      },
      {
        id: "equity-7c",
        title: "Module 7 — Trailing, current, and forward multiples",
        body: [`A multiple's denominator can be measured at different points in time, and the choice matters. A trailing multiple uses the most recent historical period's figure (like the last twelve months' earnings) — grounded in actual, reported results, but backward-looking and potentially stale if the business has changed meaningfully since. A current multiple uses the most recently available figure, which may blend historical actuals with a partial current period. A forward (leading) multiple uses a forecasted future figure (like next year's projected earnings) — more forward-looking and theoretically more relevant to an investment decision, but introduces forecast uncertainty and analyst-to-analyst variation into the multiple itself, since two analysts with different earnings forecasts for the same company will compute different forward multiples even at an identical current price.`],
        formulas: [],
      },
      {
        id: "equity-8a",
        title: "Module 8 — Financial statement forecast models in equity valuation",
        body: [`Financial statement forecast models (built out in depth in Financial Statement Analysis's Module 12) feed directly into equity valuation: rather than jumping straight to a simplified growth-rate assumption, a full forecast model projects a company's income statement, balance sheet, and cash flow statement line by line, providing the actual cash flow (FCFE, FCFF, or dividend) inputs a discounted cash flow valuation needs. The rationale for building one, rather than using a simplified shortcut, is that a full model forces internal consistency across the statements and makes every assumption explicit and auditable — a bare growth-rate guess hides far more assumptions than it reveals.`],
        formulas: [],
      },
      {
        id: "equity-8b",
        title: "Module 8 — Evaluating a forecast model's construction",
        body: [`Not every company should be modeled the same way, and evaluating whether a given model's construction actually fits the subject company is a real analytical skill. A mature, stable company with predictable margins and modest growth is well-suited to a straightforward sales-based pro forma approach (covered in Financial Statement Analysis). A company undergoing major structural change (a turnaround, a large acquisition, a shift in business mix) may need individual line items modeled more independently, since historical percentage-of-sales relationships may no longer hold. A cyclical company (tied closely to the broader business cycle from Economics) needs a model that captures that cyclicality explicitly, rather than smoothing it into a single average growth assumption. Checking that a model's structure and key assumptions actually match the company's real characteristics — rather than applying a generic template regardless of the business — is often what separates a genuinely useful forecast from a superficially precise-looking one.`],
        formulas: [],
      },
      {
        id: "equity-8c",
        title: "Module 8 — Estimating value from forecast model outputs",
        body: [`Once a financial statement forecast model is built, its outputs (projected FCFE, FCFE, dividends, or earnings) feed directly into the valuation models covered earlier in this chapter — the multistage DCF and residual income approaches from Module 6, or the forward multiples from Module 7, both draw their specific numeric inputs from exactly this kind of detailed forecast rather than from a bare, unsupported growth assumption. Interpreting the resulting value estimate well means understanding which specific assumptions are driving it most (a sensitivity analysis, varying key assumptions like margin or growth one at a time, is a standard way to see this) — an estimated value is only as trustworthy as the weakest link among the assumptions feeding it.`],
        formulas: [],
      },
      {
        id: "equity-9intro",
        title: "Module 9 — The process of industry and competitive analysis",
        body: [`Before valuing an individual company, analysts typically study the broader industry and competitive landscape it operates in, since a company's own performance is heavily shaped by the structure of the market around it. A structured process generally covers: understanding the industry's classification and how it's grouped with peers, assessing the industry's overall size, growth, and profitability trends, and analyzing the underlying competitive structure and external forces shaping it — the sequence this module follows.`],
        formulas: [],
      },
      {
        id: "equity-9b",
        title: "Module 9 — Industry classification methods",
        body: [`Companies are grouped into industries using standardized classification systems (like the Global Industry Classification Standard, or similar frameworks), typically organized hierarchically — broad sectors, subdivided into industry groups, subdivided further into specific industries. These systems are commonly built either by products/services offered (grouping companies that make similar things) or by business-cycle sensitivity (grouping companies whose fortunes move similarly with the broader economy, like cyclical versus defensive industries) — useful for building diversified portfolios or peer groups, but imperfect for companies genuinely operating across multiple distinct business lines, which a single classification code can't fully capture.`],
        formulas: [],
      },
      {
        id: "equity-9c",
        title: "Module 9 — Industry size, growth, profitability, and market share trends",
        body: [`Assessing an industry's size and growth trajectory establishes the overall opportunity available to companies within it — a company growing slower than its own industry is quietly losing relative competitive position, even while its absolute revenue still grows. Industry profitability trends (driven substantially by the Porter's five forces dynamics below) set a ceiling on how profitable individual companies within that industry can realistically sustain being over time. Market share trends — which companies are gaining or losing share within the industry — reveal competitive dynamics directly, and a company consistently gaining share, even in a slow-growing industry, can still be an attractive investment candidate on relative competitive strength alone.`],
        formulas: [],
      },
      {
        id: "equity-5b",
        title: "Module 9 — Porter's five forces and the PESTLE framework",
        body: [
          `Porter's five forces framework analyzes an industry's competitive structure: the intensity of rivalry among existing competitors, the threat of new entrants, the bargaining power of suppliers, the bargaining power of buyers, and the threat of substitute products. An industry where all five forces are weak (few competitors, high barriers to entry, weak suppliers and buyers, few substitutes) tends to support higher, more sustainable profitability than one where several forces are strong.`,
          `The PESTLE framework broadens the lens beyond pure competitive structure to external macro influences: Political (government stability, trade policy — connecting directly to the geopolitics covered in Economics), Economic (growth, interest rates, inflation — the broader business cycle context), Social (demographic shifts, changing consumer preferences), Technological (innovation and disruption risk), Legal (regulation, litigation exposure), and Environmental (climate impact and regulation, resource availability — tying into the ESG factors covered in Corporate Issuers). Where Porter's five forces analyzes competitive dynamics *within* an industry, PESTLE analyzes external forces acting *on* the industry as a whole — together, the two frameworks give a genuinely comprehensive read on both an industry's internal competitive structure and the outside forces reshaping it over time.`,
        ],
        formulas: [],
      },
      {
        id: "equity-10a",
        title: "Module 10 — A company's competitive strategy and position",
        body: [`Company-level analysis starts with understanding how a specific company competes within its industry — its chosen competitive strategy. Broadly, companies pursue either a cost leadership strategy (competing primarily on being the lowest-cost producer, allowing competitive pricing while preserving margin) or a differentiation strategy (competing on offering something distinctively different — quality, brand, features — that justifies a premium price). A company's competitive position (strong, moderate, weak) reflects how effectively it's actually executing its chosen strategy relative to peers, visible in outcomes like market share trends, margin trends relative to the industry, and customer retention — the qualitative strategy assessment and the quantitative outcomes covered next should tell a consistent, coherent story.`],
        formulas: [],
      },
      {
        id: "equity-10b",
        title: "Module 10 — Revenue drivers, operating profitability, and pricing power",
        body: [`Evaluating a company's revenue drivers means decomposing top-line growth into its actual components — volume growth (more units/customers), price/mix growth (charging more per unit, or shifting toward higher-priced offerings), and, for a diversified company, growth from new products or markets — since the sustainability and quality of revenue growth differs substantially depending on which of these is actually driving it. Operating profitability assessment looks at margin trends and their drivers — is a company's margin improving because of genuine operating leverage and efficiency, or because of one-time cost cuts unlikely to repeat? Pricing power — a company's ability to raise prices without losing proportional volume — is one of the most valuable, and most directly observable, indicators of a strong competitive position; a company that can pass through cost inflation to customers without meaningfully denting demand has real pricing power, while one that can't is more exposed to margin compression during inflationary periods (tying directly back to the inflation-forecasting content in Financial Statement Analysis).`],
        formulas: [],
      },
      {
        id: "equity-10c",
        title: "Module 10 — Working capital, capital investments, and capital structure",
        body: [`Rounding out company analysis, three additional dimensions — each covered in depth in Corporate Issuers — complete the picture. Working capital evaluation (the cash conversion cycle and liquidity management) reveals how efficiently a company manages its day-to-day operating cash needs. Capital investment evaluation (the types of capital investments and the NPV/IRR/ROIC framework) reveals whether a company is deploying capital into genuinely value-creating projects, or simply growing for growth's sake. Capital structure evaluation (the debt/equity mix and its effect on WACC) reveals how a company is financed and how much financial risk that financing choice adds on top of the company's underlying business risk. Together with the revenue/profitability/pricing analysis above, these three dimensions give a genuinely complete read on a company's operational and financial health — exactly the inputs a financial statement forecast model (Module 8) needs to project forward with real, well-grounded assumptions.`],
        formulas: [],
      },
      {
        id: "equity-11a",
        title: "Module 11 — Elements of a company research report",
        body: [`A well-constructed equity research report typically covers: an investment summary/thesis and recommendation stated up front; the valuation methodology and resulting estimate (drawing on the models covered throughout this chapter); the industry and competitive positioning analysis (Modules 9-10); financial analysis and forecasts (Financial Statement Analysis and Module 8); key risks to the thesis (both company-specific and broader macro/industry risks); and catalysts (specific upcoming events that could move the stock toward the analyst's estimated value). A report that states a target price without clearly showing the reasoning and risks behind it offers far less genuine analytical value than one that makes its full logic — and its vulnerabilities — transparent and checkable.`],
        formulas: [],
      },
      {
        id: "equity-11b",
        title: "Module 11 — Sell-side vs. buy-side research reports",
        body: [`Sell-side analysts work for brokerages/investment banks and publish research broadly to the bank's clients — their reports are typically public-facing (at least to clients), and sell-side firms' compensation and business relationships (including investment banking business with the very companies they cover) can create real, well-documented incentive conflicts toward optimistic ("buy") recommendations. Buy-side analysts work internally for asset managers, pension funds, or other institutional investors, producing research used purely for that firm's own internal investment decisions — not published externally, and generally viewed as facing fewer structural conflicts of interest, since the buy-side analyst's own firm's investment performance depends directly on getting the call right, rather than on maintaining a banking relationship with the company being covered.`],
        formulas: [],
      },
      {
        id: "equity-11c",
        title: "Module 11 — Why value estimates differ across analysts",
        body: [`Two analysts using the exact same valuation model (say, a two-stage FCFE model) can still reach meaningfully different value estimates for the same company, purely because they input different assumptions. Differing revenue assumptions (growth rate, market share trajectory) directly change the projected cash flow stream. Differing profitability assumptions (margin trends, cost structure) change how much of that revenue converts to cash flow. Differing investment assumptions (capital expenditure requirements, working capital needs) change how much of that cash flow is actually available to shareholders after reinvestment. Differing financing assumptions (capital structure, cost of capital) change both the cash flow available to equity specifically and the discount rate applied to it. Recognizing this is genuinely useful in practice: when comparing two analysts' differing price targets for the same stock, the more productive question is usually "which specific assumption differs, and whose is more defensible?" rather than simply picking whichever number sounds more appealing.`],
        formulas: [],
      },
      {
        id: "equity-12a",
        title: "Module 12 — CAPM and the market model for required return",
        body: [`The capital asset pricing model (CAPM), covered in full in Portfolio Management, is the standard tool for estimating a company's required return on equity: required return equals the risk-free rate plus beta times the market risk premium — capturing the idea that only systematic (market-wide) risk, not company-specific risk, should be compensated with extra expected return. The market model is the practical regression tool used to actually estimate that beta in the first place (covered in Simple Linear Regression): regressing a stock's historical returns against the broader market's returns, where the resulting slope coefficient *is* the beta that CAPM then uses. This required return estimate is exactly the discount rate used throughout this chapter's present value models (Module 6) — the market model estimates beta, CAPM converts that beta into a required return, and the present value models then use that required return to discount the company's expected future cash flows into a value estimate.`],
        formulas: [],
      },
      {
        id: "equity-12b",
        title: "Module 12 — Arbitrage pricing theory and multi-factor models",
        body: [`Arbitrage pricing theory (APT) generalizes CAPM's single-factor (market beta) approach into a multi-factor framework: rather than assuming a stock's required return depends on exposure to just one systematic risk factor (the market), APT allows for several distinct systematic risk factors simultaneously (such as interest rate risk, inflation risk, or industrial production growth), each with its own sensitivity (factor beta) and its own associated risk premium. Multi-factor models built on this same logic are widely used in practice, particularly by institutional investors, since real-world stock returns are demonstrably influenced by more than just overall market movements — factors like company size, valuation (value vs. growth), and profitability have been shown to have their own persistent, systematic influence on returns beyond what a single market-beta CAPM captures alone. The practical importance of multi-factor models is that they let an investor decompose a portfolio's risk and return along multiple specific dimensions, rather than the single "market risk" dimension CAPM alone provides — a materially richer, though also more complex, way to understand where a portfolio's returns are actually coming from.`],
        formulas: [],
      },
      {
        id: "equity-6",
      ...
      },
      {
        ...
        body: [`Match the question to the concept.`],
        decisionRows: [
          { cue: "Fixed dividend, paid before common shareholders, usually no vote", formula: "Preferred stock", section: "equity-1b" },
          { cue: "Residual ownership, votes, last claim on assets", formula: "Common stock", section: "equity-1b" },
          { cue: "Shares held privately, limited liquidity, negotiated disclosure", formula: "Private equity securities", section: "equity-1c" },
          { cue: "How institutional voting recommendations get made", formula: "Proxy advisors / the voting process", section: "equity-2b" },
          { cue: "Where a company raises new capital directly (e.g., an IPO)", formula: "Primary market", section: "equity-3" },
          { cue: "Investors trading existing shares among themselves", formula: "Secondary market", section: "equity-3" },
          { cue: "How many shares are actually available to trade", formula: "Float", section: "equity-3c" },
          { cue: "How easily a position could be bought/sold without moving price", formula: "Average daily volume", section: "equity-3c" },
          { cue: "Finding the price at which a leveraged position triggers a broker call", formula: "Margin call price", section: "equity-3h" },
          { cue: "First date a share trades without the upcoming dividend", formula: "Ex-dividend date", section: "equity-3f" },
          { cue: "Return including both price change and dividends received", formula: "Total return", section: "equity-3g" },
          { cue: "Comparing current market price to an estimate of intrinsic value", formula: "Price vs. value", section: "equity-5intro" },
          { cue: "Capturing total business value regardless of financing", formula: "Enterprise value", section: "equity-5intro2" },
          { cue: "Starting from book value and adding future residual income", formula: "Residual income model", section: "equity-6a" },
          ...
          { cue: "A company with a growth rate expected to shift/slow over time", formula: "Two-stage (multistage) DDM", section: "equity-4b" },
          { cue: "Valuing a non-callable, non-convertible preferred stock", formula: "Preferred stock valuation (level perpetuity)", section: "equity-6c" },
          { cue: "Comparing a stock's multiple to similar peer companies' multiples", formula: "Method of comparables", section: "equity-7intro" },
          { cue: "Deriving a multiple from a company's own growth/risk fundamentals", formula: "Method of forecasted fundamentals", section: "equity-7intro" },
          { cue: "Comparing companies with very different debt levels", formula: "EV/EBITDA multiple", section: "equity-5" },
          { cue: "A multiple based on next year's projected earnings", formula: "Forward (leading) multiple", section: "equity-7c" },
          { cue: "Projecting a full income statement, balance sheet, and cash flow statement", formula: "Financial statement forecast model", section: "equity-8a" },
          { cue: "Grouping companies by products/services or business-cycle sensitivity", formula: "Industry classification methods", section: "equity-9b" },
          { cue: "Assessing industry structure and competitive intensity", formula: "Porter's five forces", section: "equity-5b" },
          { cue: "Assessing political, economic, social, technological, legal, environmental forces", formula: "PESTLE framework", section: "equity-5b" },
          { cue: "Competing on lowest cost vs. differentiated offering", formula: "Competitive strategy", section: "equity-10a" },
          { cue: "Ability to raise prices without losing proportional volume", formula: "Pricing power", section: "equity-10b" },
          { cue: "A brokerage's research, potentially conflicted by banking relationships", formula: "Sell-side research", section: "equity-11b" },
          { cue: "An asset manager's internal-only research", formula: "Buy-side research", section: "equity-11b" },
          { cue: "Estimating required return from beta and the market risk premium", formula: "CAPM", section: "equity-12a" },
          { cue: "Multiple systematic risk factors beyond just market beta", formula: "Arbitrage pricing theory (APT)", section: "equity-12b" },
        ],
        formulas: [],
      },
      {
        ...
        referenceRows: [
          ...
          { item: "Forgetting the r > g requirement", detail: "Same trap as the growing perpetuity in Quantitative Methods — the model is undefined or nonsensical if growth meets or exceeds the required return." },
          { item: "Treating a low P/E as automatically \"cheap\"", detail: "A low multiple can also reflect real weaknesses (weak growth, high risk) rather than a bargain." },
          { item: "Confusing book value with intrinsic value", detail: "Book value reflects historical accounting cost, not current market or economic value — often a poor proxy, especially for intangible-heavy businesses." },
          { item: "Assuming market capitalization captures total firm value", detail: "Market cap excludes debt entirely; enterprise value is needed to capture the whole capital structure." },
          { item: "Assuming price return equals total return", detail: "Price return ignores dividends — for a dividend-paying stock, total return is meaningfully higher." },
          { item: "Assuming a terminal value assumption is a minor detail", detail: "In a multistage model, the terminal value often represents the large majority of total estimated value — small changes in the stable growth assumption can swing the whole valuation." },
          { item: "Assuming sell-side research is unbiased", detail: "Banking relationships and business incentives can create a documented tilt toward optimistic recommendations — buy-side research generally faces fewer such structural conflicts." },
          { item: "Confusing Porter's five forces with PESTLE", detail: "Porter's five forces analyzes competitive structure within an industry; PESTLE analyzes external macro forces acting on the industry as a whole." },
        ],
        formulas: [],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "fi-2b-zero", name: "Zero-coupon bond price", expression: "Price = <span class=\"frac\"><span class=\"num\">Face value</span><span class=\"den\">(1 + r)<sup>n</sup></span></span>", when: "No coupon payments at all — just a single lump sum at maturity.", problem: "A $1,000 face value zero-coupon bond matures in 5 years; the market yield is 6%. What is its price?", given: ["Face value = $1,000", "r = 0.06", "n = 5"], worked: "Price = 1,000 / (1.06)<sup>5</sup>\nPrice \u2248 1,000 / 1.3382\nPrice \u2248 $747.26\n\n(the entire $252.74 gain over 5 years is the\nreturn \u2014 no coupons paid along the way)" },
        ],
      },
      {
        id: "fi-3",
        ...
        formulas: [
          { id: "fi-3-price", name: "Bond price", expression: "Price = PV(coupon annuity) + PV(face value)", when: "Finding a bond's fair price given its coupon, face value, maturity, and required yield.", problem: "A $1,000 face value bond, 6% annual coupon, 3 years to maturity, and an 8% market yield. What is the bond's price?", given: ["Face value = $1,000", "Coupon = $60/year (6%)", "n = 3 years", "r = 0.08"], worked: "PV(coupons) \u2248 $154.63\nPV(face value) \u2248 $793.83\nPrice \u2248 154.63 + 793.83\nPrice \u2248 $948.46\n\n(a discount, since the 6% coupon is below the 8% yield)" },
        ],
      },
      {
        id: "fi-3b",
      ...
      },
      {
        ...
        formulas: [
          { id: "fi-4-current", name: "Current yield", expression: "Current yield = <span class=\"frac\"><span class=\"num\">Annual coupon payment</span><span class=\"den\">Current bond price</span></span>", when: "A quick, rough yield estimate — ignores any price gain/loss to maturity.", problem: "A bond with a $60 annual coupon currently trades at $948. What is its current yield?", given: ["Annual coupon = $60", "Current price = $948"], worked: "Current yield = 60 / 948\nCurrent yield \u2248 6.33%\n\n(higher than the 6% coupon rate, simply because\nthe bond is trading below face value)" },
        ],
      },
      {
        id: "fi-4b",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "deriv-3c-parity", name: "Put-call parity", expression: "Call price + <span class=\"frac\"><span class=\"num\">Strike price</span><span class=\"den\">(1+r)<sup>t</sup></span></span> = Put price + Stock price", when: "Checking whether call price, put price, strike, and stock price are mutually consistent — or backing out one of them given the other three.", problem: "A stock trades at $52. A 1-year call and put, both with a $50 strike, exist in a market with a 4% risk-free rate, and the put trades at $2.50. What should the call be worth?", given: ["Stock price = $52", "Strike = $50", "r = 0.04", "t = 1 year", "Put price = $2.50"], worked: "Call + 50/(1.04) = 2.50 + 52\nCall + 48.08 = 54.50\nCall \u2248 $6.42" },
        ],
      },
      {
        id: "deriv-3d",
        ...
        formulas: [
          { id: "deriv-3d-carry", name: "Cost of carry (forward price)", expression: "Forward price = Spot price \u00D7 (1+r)<sup>t</sup> + Carry costs \u2212 Carry benefits", when: "Finding the no-arbitrage forward price of an asset, given its spot price and the costs/benefits of holding it.", problem: "A stock trades at $100 today, the risk-free rate is 5%, the forward contract matures in 1 year, and the stock pays no dividend. What is the no-arbitrage forward price?", given: ["Spot price = $100", "r = 0.05", "t = 1 year", "Carry benefits = $0 (no dividend)"], worked: "Forward price = 100 \u00D7 (1.05)\nForward price = $105\n\n(if the stock instead paid a $2 dividend,\nforward price = 105 \u2212 2 = $103)" },
        ],
      },
      {
        id: "deriv-3e",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "port-3-return", name: "Portfolio expected return", expression: "E(Rp) = \u03A3 [ wi \u00D7 E(Ri) ]", when: "Finding a portfolio's overall expected return from its holdings' weights and expected returns.", problem: "A portfolio is 60% Stock A (10% expected return) and 40% Stock B (6% expected return). What is the portfolio's expected return?", given: ["wA = 0.60, E(RA) = 10%", "wB = 0.40, E(RB) = 6%"], worked: "E(Rp) = (0.60\u00D710%) + (0.40\u00D76%)\nE(Rp) = 6% + 2.4%\nE(Rp) = 8.4%" },
          { id: "port-3-minvar", name: "Minimum-variance weight (two-asset portfolio) — advanced", expression: "w1 = <span class=\"frac\"><span class=\"num\">\u03C32\u00B2 \u2212 Cov(1,2)</span><span class=\"den\">\u03C31\u00B2 + \u03C32\u00B2 \u2212 2 \u00D7 Cov(1,2)</span></span>", when: "Finding the weight in asset 1 that minimizes the overall portfolio's variance, for a two-asset portfolio.", problem: "Stock 1 has variance 0.04, Stock 2 has variance 0.09, and their covariance is 0.02. What weight in Stock 1 minimizes the portfolio's variance?", given: ["\u03C31\u00B2 = 0.04", "\u03C32\u00B2 = 0.09", "Cov(1,2) = 0.02"], worked: "w1 = (0.09 \u2212 0.02) / (0.04 + 0.09 \u2212 2\u00D70.02)\nw1 = 0.07 / 0.09\nw1 \u2248 77.8%\n\n(holds about 78% Stock 1, 22% Stock 2 \u2014\nnot the highest-return mix, just the lowest-risk one)" },
        ],
      },
      {
        id: "port-4",
      ...
      },
      {
        ...
        formulas: [
          { id: "port-5c-capm", name: "Capital asset pricing model (CAPM)", expression: "E(Ri) = Rf + \u03B2i \u00D7 [E(Rm) \u2212 Rf]", when: "Finding an asset's required return based purely on its systematic risk (beta).", problem: "The risk-free rate is 3%, the expected market return is 9%, and a stock has a beta of 1.4. What return does CAPM require for this stock?", given: ["Rf = 3%", "E(Rm) = 9%", "\u03B2i = 1.4"], worked: "E(Ri) = 3% + 1.4 \u00D7 (9% \u2212 3%)\nE(Ri) = 3% + 1.4 \u00D7 6%\nE(Ri) = 3% + 8.4%\nE(Ri) = 11.4%" },
        ],
      },
      {
        id: "port-5d",
        ...
        formulas: [
          { id: "port-5d-sharpe", name: "Sharpe ratio", expression: "Sharpe = <span class=\"frac\"><span class=\"num\">Rp \u2212 Rf</span><span class=\"den\">\u03C3p</span></span>", when: "Comparing risk-adjusted return using total risk — appropriate for an investor's entire portfolio.", problem: "A portfolio returns 11%, the risk-free rate is 3%, and the portfolio's standard deviation is 16%. What is its Sharpe ratio?", given: ["Rp = 11%", "Rf = 3%", "\u03C3p = 16%"], worked: "Sharpe = (11% \u2212 3%) / 16%\nSharpe = 8/16\nSharpe = 0.50" },
          { id: "port-5d-treynor", name: "Treynor ratio", expression: "Treynor = <span class=\"frac\"><span class=\"num\">Rp \u2212 Rf</span><span class=\"den\">\u03B2p</span></span>", when: "Comparing risk-adjusted return using only systematic risk — appropriate for one holding within a larger diversified portfolio.", problem: "The same portfolio returns 11%, the risk-free rate is 3%, and its beta is 1.2. What is its Treynor ratio?", given: ["Rp = 11%", "Rf = 3%", "\u03B2p = 1.2"], worked: "Treynor = (11% \u2212 3%) / 1.2\nTreynor = 8 / 1.2\nTreynor \u2248 6.67" },
          { id: "port-5d-jensen", name: "Jensen's alpha", expression: "\u03B1p = Rp \u2212 [Rf + \u03B2p \u00D7 (Rm \u2212 Rf)]", when: "Measuring return earned above or below what CAPM predicts for that level of systematic risk.", problem: "The same portfolio returns 11%, has a beta of 1.2, the risk-free rate is 3%, and the market return is 9%. What is its Jensen's alpha?", given: ["Rp = 11%", "\u03B2p = 1.2", "Rf = 3%", "Rm = 9%"], worked: "CAPM-predicted = 3% + 1.2\u00D7(9%\u22123%)\nCAPM-predicted = 3% + 7.2% = 10.2%\n\n\u03B1p = 11% \u2212 10.2%\n\u03B1p = 0.8%\n\n(small positive alpha \u2014 modest outperformance\nafter adjusting for systematic risk)" },
        ],
      },
      {
        id: "port-5e",
...
const QUIZZES = {
  ...
  econ: [
    ...
    { id: "econ-q4", question: "A firm's price sits below average total cost (ATC) but above average variable cost (AVC). In the short run, it should generally", options: ["Shut down immediately", "Keep producing despite the loss", "Double its output", "Raise its price to exactly ATC"], correct: 1, explanation: "Above AVC but below ATC, producing still covers all variable costs plus part of fixed costs — better than shutting down.", remediation: "econ-5" },
    { id: "econ-q5", question: "As a firm grows, average costs fall due to bulk purchasing and specialized labor. This describes", options: ["Diseconomies of scale", "Economies of scale", "The shutdown point", "Elasticity"], correct: 1, explanation: "Falling average costs as output rises describes economies of scale.", remediation: "econ-6" },
    { id: "econ-q6", question: "A monopolistically competitive firm's demand curve is", options: ["Perfectly flat (horizontal)", "Downward-sloping, due to product differentiation", "Perfectly vertical", "Undefined"], correct: 1, explanation: "Product differentiation gives each firm some pricing power, hence a downward-sloping demand curve.", remediation: "econ-7" },
    { id: "econ-q7", question: "In the kinked demand curve model of oligopoly, firms generally expect rivals to", options: ["Match price cuts but not price increases", "Match price increases but not price cuts", "Ignore all price changes", "Always cut prices first"], correct: 0, explanation: "This asymmetric expectation is what creates the kink and tends to keep oligopoly prices stable.", remediation: "econ-8" },
    { id: "econ-q8", question: "Four firms have market shares of 40%, 30%, 20%, and 10%. What is the HHI?", options: ["100", "3,000", "1,000", "30"], correct: 1, explanation: "HHI = 40\u00B2+30\u00B2+20\u00B2+10\u00B2 = 1,600+900+400+100 = 3,000.", remediation: "econ-9" },
    { id: "econ-q9", question: "Which measure adjusts for inflation?", options: ["Nominal GDP", "Real GDP", "Neither", "Both equally"], correct: 1, explanation: "Real GDP strips out the effect of price changes.", remediation: "econ-10" },
    { id: "econ-q10", question: "A credit cycle refers to", options: ["The four phases of GDP growth only", "The expansion and contraction of credit availability and borrowing costs", "A central bank's inflation target", "The trade balance over time"], correct: 1, explanation: "Credit cycles describe recurring loosening/tightening of credit conditions, related to but distinct from the business cycle.", remediation: "econ-11" },
    { id: "econ-q11", question: "Building permits are typically classified as which type of economic indicator?", options: ["Lagging", "Coincident", "Leading", "None of these"], correct: 2, explanation: "Building permits tend to change before the broader economy does — a leading indicator.", remediation: "econ-12" },
    { id: "econ-q12", question: "One argument that a high debt-to-GDP ratio may NOT be as concerning is when", options: ["The debt is owed entirely to foreign creditors", "The country borrows in its own currency and funds productive investment", "Interest rates are very high", "The government has no central bank"], correct: 1, explanation: "Debt sustainability depends heavily on circumstances like currency of borrowing and what the debt funds.", remediation: "econ-13" },
    { id: "econ-q13", question: "Unemployment benefits rising automatically during a recession, without new legislation, is an example of", options: ["A discretionary fiscal tool", "An automatic stabilizer", "Monetary policy", "A trade restriction"], correct: 1, explanation: "Transfer payments like unemployment benefits act as automatic stabilizers.", remediation: "econ-14" },
    { id: "econ-q14", question: "Which fiscal policy stance is intended to stimulate a weak economy?", options: ["Contractionary (higher taxes, lower spending)", "Expansionary (lower taxes, higher spending)", "Neutral", "Currency intervention"], correct: 1, explanation: "Expansionary fiscal policy increases spending and/or decreases taxes to stimulate demand.", remediation: "econ-15" },
    { id: "econ-q15", question: "A key reason central banks are typically given independence from elected government is to", options: ["Reduce transparency", "Insulate monetary policy decisions from short-term political pressure", "Guarantee zero inflation", "Eliminate the need for fiscal policy"], correct: 1, explanation: "Independence helps ensure policy decisions aren't swayed by short-term political considerations.", remediation: "econ-16" },
    { id: "econ-q16", question: "A central bank buying government securities to add money to the banking system is using", options: ["Reserve requirements", "Open market operations", "Fiscal policy", "A trade tariff"], correct: 1, explanation: "Open market operations involve the central bank buying/selling government securities.", remediation: "econ-17" },
    { id: "econ-q17", question: "A central bank committing to keep inflation near a specific numeric target is practicing", options: ["Exchange rate targeting", "Interest rate targeting only", "Inflation targeting", "Fiscal policy"], correct: 2, explanation: "Inflation targeting is the most common modern monetary policy framework.", remediation: "econ-18" },
    { id: "econ-q18", question: "Loose monetary policy alongside loose fiscal policy tends to", options: ["Cancel each other out completely", "Compound stimulus (and inflation risk)", "Have no combined effect", "Only affect exchange rates"], correct: 1, explanation: "Policies pointed in the same direction tend to reinforce, not cancel, each other's effects.", remediation: "econ-19" },
    { id: "econ-q19", question: "Two countries cooperating closely on trade while competing sharply over technology standards illustrates", options: ["A pure cooperation relationship", "A pure competition relationship", "Most real-world relationships mixing both at once", "An impossible scenario"], correct: 2, explanation: "Most geopolitical relationships blend cooperation and competition simultaneously across different domains.", remediation: "econ-20" },
    { id: "econ-q20", question: "Deeply intertwined economies having more to lose from open conflict is an example of how globalization can", options: ["Have no relationship to geopolitics", "Act as a stabilizing force on geopolitical tension", "Only increase conflict risk", "Eliminate all trade"], correct: 1, explanation: "High economic interdependence can raise the cost of conflict, acting as a stabilizing factor.", remediation: "econ-21" },
    { id: "econ-q21", question: "Which organization primarily provides short-term financial assistance to countries facing balance-of-payments crises?", options: ["The World Bank", "The International Monetary Fund (IMF)", "The World Trade Organization", "A regional trading bloc"], correct: 1, explanation: "The IMF focuses on monetary cooperation and short-term financial stability assistance.", remediation: "econ-22" },
    { id: "econ-q22", question: "Geopolitical risk is often described along which two dimensions?", options: ["Cost and benefit", "Likelihood and potential magnitude of impact", "Tariffs and quotas", "Import and export volume"], correct: 1, explanation: "Geopolitical risk is assessed by both how likely an event is and how large its impact would be.", remediation: "econ-23" },
    { id: "econ-q23", question: "Which of these is a tool of geopolitics short of military conflict?", options: ["Economic sanctions", "GDP growth", "The business cycle", "Elasticity of demand"], correct: 0, explanation: "Sanctions are a common non-military tool used to pursue geopolitical objectives.", remediation: "econ-24" },
    { id: "econ-q24", question: "A company with no direct operations in an affected region can still face geopolitical risk through", options: ["It cannot be affected at all", "Supply chain exposure and broad market risk-premium effects", "Only currency effects", "Only if it exports goods there"], correct: 1, explanation: "Indirect channels like supply chains and broad risk premiums can transmit geopolitical risk even without direct exposure.", remediation: "econ-25" },
    { id: "econ-q25", question: "Countries trade because of", options: ["Absolute advantage only", "Comparative advantage", "Government mandates only", "Currency pegs"], correct: 1, explanation: "Comparative advantage means both countries gain by specializing in what each produces relatively best.", remediation: "econ-26" },
    { id: "econ-q26", question: "Which trade restriction generates direct government revenue (unlike the others)?", options: ["A quota", "A tariff", "An export subsidy", "A currency peg"], correct: 1, explanation: "A tariff is a tax on imports, directly generating government revenue; a quota generally does not.", remediation: "econ-27" },
    { id: "econ-q27", question: "An agreement with free trade in goods AND free movement of labor and capital between members, but not fully unified economic policy, is best described as a", options: ["Free trade area", "Customs union", "Common market", "Economic union"], correct: 2, explanation: "A common market adds free movement of labor/capital on top of free trade in goods.", remediation: "econ-28" },
    { id: "econ-q28", question: "EUR/USD moves from 1.05 to 1.12. What is the approximate percentage change?", options: ["+5%", "+6.67%", "+7%", "\u22126.67%"], correct: 1, explanation: "(1.12\u22121.05)/1.05 \u2248 +6.67%.", remediation: "econ-29" },
    { id: "econ-q29", question: "A country committing to keep its currency at a fixed value against another, actively intervening to defend that level, uses a", options: ["Floating regime", "Fixed (pegged) regime", "Managed float only", "No regime at all"], correct: 1, explanation: "A fixed/pegged regime commits to defending a specific exchange rate value.", remediation: "econ-30" },
    { id: "econ-q30", question: "A common objective of government-imposed capital restrictions is to", options: ["Maximize currency speculation", "Protect a fixed or managed exchange rate from destabilizing flows", "Eliminate the need for a central bank", "Guarantee export subsidies"], correct: 1, explanation: "Capital restrictions often aim to protect exchange rate regimes, reserves, or monetary policy independence.", remediation: "econ-31" },
    { id: "econ-q31", question: "EUR/USD = 1.10 and GBP/USD = 1.25. What is EUR/GBP?", options: ["1.375", "0.88", "1.14", "0.72"], correct: 1, explanation: "EUR/GBP = (EUR/USD) \u00F7 (GBP/USD) = 1.10 / 1.25 = 0.88.", remediation: "econ-32" },
    { id: "econ-q32", question: "A spot rate of 1.1050 with forward points of +0.0025 gives a forward rate of", options: ["1.1025", "1.1075", "1.1050", "1.1300"], correct: 1, explanation: "Forward rate = spot rate + forward points = 1.1050 + 0.0025 = 1.1075.", remediation: "econ-33" },
  ],
  fsa: [
    ...
    { id: "fsa-q19", question: "A convertible bond would increase diluted EPS above basic EPS if included. What should happen to it?", options: ["Include it anyway, since it's convertible", "Exclude it — it's antidilutive", "Double its effect", "Report it as a discontinued operation"], correct: 1, explanation: "A security that would increase EPS if included is antidilutive and must be excluded from diluted EPS.", remediation: "fsa-5d" },
    { id: "fsa-q20", question: "The direct and indirect cash flow statement methods differ in", options: ["Their final total operating cash flow", "Only how the operating section is presented", "Whether investing activities are included", "Whether they apply under IFRS or GAAP only"], correct: 1, explanation: "Both methods reach the identical operating cash flow total — they differ only in presentation.", remediation: "fsa-cf2" },
    { id: "fsa-q21", question: "Revenue is $1,000,000 and accounts receivable increased by $60,000. How much cash was actually collected from customers?", options: ["$1,060,000", "$940,000", "$1,000,000", "$60,000"], correct: 1, explanation: "Cash collections = Revenue \u2212 increase in receivables = 1,000,000 \u2212 60,000 = $940,000.", remediation: "fsa-cf3" },
    { id: "fsa-q22", question: "Under US GAAP, interest paid must be classified as which type of cash flow activity?", options: ["Investing, always", "Financing, always", "Operating, always", "Either operating or financing, analyst's choice"], correct: 2, explanation: "US GAAP requires interest paid and received to be classified as operating; IFRS allows more flexibility.", remediation: "fsa-cf4" },
    { id: "fsa-q23", question: "FCFF is $1,925,000, interest is $300,000 (25% tax rate), and net new borrowing is $150,000. What is FCFE?", options: ["$1,775,000", "$1,850,000", "$2,000,000", "$1,625,000"], correct: 1, explanation: "FCFE = 1,925,000 \u2212 300,000\u00D7(1\u22120.25) + 150,000 = 1,925,000 \u2212 225,000 + 150,000 = $1,850,000.", remediation: "fsa-cf6" },
    { id: "fsa-q24", question: "Inventory's recorded cost exceeds its net realizable value. What must the company do?", options: ["Nothing, until the inventory is sold", "Write the inventory down and recognize the loss immediately", "Write the inventory up to fair value", "Restate all prior periods"], correct: 1, explanation: "Inventory can never be reported above net realizable value; a write-down is required immediately.", remediation: "fsa-3b2" },
    { id: "fsa-q25", question: "An asset's book value exceeds its recoverable value. This describes", options: ["Amortization", "Impairment", "A permanent difference", "Derecognition"], correct: 1, explanation: "Impairment occurs when book value exceeds recoverable value, requiring a write-down.", remediation: "fsa-3c2" },
    { id: "fsa-q26", question: "Which type of book-tax difference never creates a deferred tax asset or liability?", options: ["Temporary difference", "Permanent difference", "Depreciation timing difference", "Any difference involving inventory"], correct: 1, explanation: "Permanent differences never reverse, so there's nothing to defer — no DTA or DTL is created.", remediation: "fsa-3d" },
    { id: "fsa-q27", question: "Pre-tax income is $10,000,000 and income tax expense is $2,200,000. What is the effective tax rate?", options: ["25%", "22%", "20%", "28%"], correct: 1, explanation: "Effective tax rate = 2,200,000 / 10,000,000 = 22%.", remediation: "fsa-3d2" },
    { id: "fsa-q28", question: "A company reports accurately and transparently, even though its actual results for the year were poor. This company has", options: ["Low financial reporting quality", "High financial reporting quality, regardless of the quality of results", "High-quality results", "Committed fraud"], correct: 1, explanation: "Reporting quality (honesty/transparency) is distinct from quality of results (how good the underlying performance actually is).", remediation: "fsa-5" },
    { id: "fsa-q29", question: "Opportunity, incentive/pressure, and rationalization together form which framework for assessing fraud risk?", options: ["The DuPont framework", "The fraud triangle", "Porter's five forces", "The quality spectrum"], correct: 1, explanation: "The fraud triangle identifies these three conditions as jointly raising fraud risk.", remediation: "fsa-5g" },
    { id: "fsa-q30", question: "A company's \"adjusted EBITDA\" figure is best treated by an analyst as", options: ["Fully audited and directly comparable across companies", "A management-defined metric that should be reconciled back to GAAP/IFRS figures", "Always more reliable than GAAP net income", "Irrelevant and safe to ignore entirely"], correct: 1, explanation: "Non-GAAP measures are management-defined and not subject to the same audit rigor — always reconcile to the nearest standardized figure.", remediation: "fsa-5i" },
    { id: "fsa-q31", question: "A company has 18% ROE with an asset turnover of 1.5. If turnover improves to 1.8 with margin and leverage unchanged, what is the new ROE?", options: ["18.6%", "21.6%", "20.0%", "24.0%"], correct: 1, explanation: "New ROE = 18% \u00D7 (1.8/1.5) = 18% \u00D7 1.2 = 21.6%.", remediation: "fsa-5c" },
    { id: "fsa-q32", question: "In a sales-based pro forma model, which line item is typically forecast first, with most others scaled to it?", options: ["Income tax expense", "Revenue", "Retained earnings", "Goodwill"], correct: 1, explanation: "Revenue is forecast first, since most other line items are commonly modeled as a percentage of revenue.", remediation: "fsa-12a" },
    { id: "fsa-q33", question: "An analyst keeps a forecast unchanged despite new information suggesting it should be revised. This illustrates", options: ["Herding", "Anchoring bias", "Confirmation bias", "Overconfidence"], correct: 1, explanation: "Anchoring is clinging too closely to a prior estimate despite new contrary information.", remediation: "fsa-12b" },
  ],
  corp: [
    { id: "corp-q1", question: "Which organizational form gives owners limited liability (they can lose their investment, but no more)?", options: ["Sole proprietorship", "General partnership", "Corporation", "None of these"], correct: 2, explanation: "The corporate form uniquely separates the business as a distinct legal entity, giving owners limited liability.", remediation: "corp-2" },
    { id: "corp-q2", question: "Compared to a publicly traded corporation, a privately held one generally offers owners", options: ["More liquidity and less privacy", "Less liquidity but more operating privacy", "Identical liquidity", "No access to any capital at all"], correct: 1, explanation: "Private ownership sacrifices easy share liquidity in exchange for privacy and freedom from public market pressure.", remediation: "corp-4" },
    { id: "corp-q3", question: "Compared to a shareholder's claim, a lender's claim on the company is", options: ["Residual and unlimited upside", "Fixed/contractual, and paid first", "Identical in every way", "Paid only if the company is profitable"], correct: 1, explanation: "Lenders hold a fixed contractual claim paid before shareholders; shareholders hold the residual, unlimited-upside claim.", remediation: "corp-5" },
    { id: "corp-q4", question: "Board structure, executive compensation design, and shareholder rights are all examples of which ESG component?", options: ["Environmental", "Social", "Governance", "None of these"], correct: 2, explanation: "These are governance factors — how the company is run.", remediation: "corp-7" },
    { id: "corp-q5", question: "Shareholders delegating day-to-day decision-making to management, whose interests may not fully align with shareholders', describes", options: ["A trading bloc", "The principal-agent relationship", "A capital allocation pitfall", "A real option"], correct: 1, explanation: "This is the classic principal-agent (agency) relationship and its associated conflict.", remediation: "corp-8" },
    { id: "corp-q6", question: "Which of these is a corporate governance mechanism specifically meant to align management's incentives with long-term shareholder value?", options: ["A higher corporate tax rate", "Equity-based executive compensation with multi-year vesting", "A shorter cash conversion cycle", "A lower WACC"], correct: 1, explanation: "Vesting equity compensation over time is designed to align management's incentives with long-term value creation.", remediation: "corp-9" },
    { id: "corp-q7", question: "Inventory outstanding 60 days, receivables 45 days, payables 30 days. What is the cash conversion cycle?", options: ["135 days", "75 days", "90 days", "15 days"], correct: 1, explanation: "CCC = 60 + 45 \u2212 30 = 75 days.", remediation: "corp-11" },
    { id: "corp-q8", question: "A company is profitable but struggles to pay bills because cash is tied up in slow-paying receivables. This is best described as a problem with", options: ["Profitability", "Liquidity", "Capital structure", "Business model"], correct: 1, explanation: "Liquidity is the ability to meet short-term obligations, distinct from profitability.", remediation: "corp-12" },
    { id: "corp-q9", question: "A capital investment required by environmental regulation, typically evaluated on cost-minimization rather than a standard return calculation, is a", options: ["Going-concern investment", "Regulatory/compliance investment", "Expansion investment", "New-venture investment"], correct: 1, explanation: "Regulatory/compliance investments are mandatory and generally not evaluated the same way as discretionary projects.", remediation: "corp-14" },
    { id: "corp-q10", question: "A project has a positive NPV. What does that suggest?", options: ["It's expected to destroy value", "It's expected to add value", "Its IRR equals zero", "It should always be rejected"], correct: 1, explanation: "Positive NPV means the project is expected to add value.", remediation: "corp-15" },
    { id: "corp-q11", question: "IRR is defined as the discount rate at which NPV equals", options: ["The cost of capital", "One", "Zero", "The initial investment"], correct: 2, explanation: "IRR is the break-even discount rate where NPV = 0.", remediation: "corp-15" },
    { id: "corp-q12", question: "A company has NOPAT of $18 million and invested capital of $150 million. What is its ROIC?", options: ["8.3%", "12%", "18%", "6%"], correct: 1, explanation: "ROIC = 18/150 = 12%.", remediation: "corp-15" },
    { id: "corp-q13", question: "Ignoring money already spent on a failed prototype when deciding whether to continue a project reflects which capital allocation principle?", options: ["Include opportunity costs", "Ignore sunk costs", "Use accounting earnings", "Maximize EPS"], correct: 1, explanation: "Sunk costs are unrecoverable and irrelevant to the forward-looking decision.", remediation: "corp-16" },
    { id: "corp-q14", question: "The ability to shut down or exit a poorly performing project early, limiting downside, is an example of", options: ["A timing option", "An abandonment option", "An expansion option", "A flexibility option"], correct: 1, explanation: "An abandonment option is the right to exit a project early.", remediation: "corp-17" },
    { id: "corp-q15", question: "E=$600M, D=$400M, Re=12%, Rd=6%, tax rate=25%. What is WACC?", options: ["9.0%", "10.5%", "6.9%", "12.0%"], correct: 0, explanation: "WACC = (0.6\u00D712%) + (0.4\u00D76%\u00D70.75) = 7.2% + 1.8% = 9.0%.", remediation: "corp-18" },
    { id: "corp-q16", question: "A young, high-growth company with uncertain cash flows typically relies more heavily on", options: ["Debt financing", "Equity financing", "Government subsidies", "Trade credit only"], correct: 1, explanation: "Uncertain cash flows make heavy debt riskier; equity is more common for early-stage, high-growth companies.", remediation: "corp-19" },
    { id: "corp-q17", question: "In the simplest Modigliani-Miller framework (no taxes), a company's capital structure", options: ["Determines its total value entirely", "Does not affect its total value", "Only matters for large companies", "Eliminates all financial risk"], correct: 1, explanation: "In the simplest MM framework, total firm value is unaffected by the debt/equity mix.", remediation: "corp-20" },
    { id: "corp-q18", question: "A company's desired long-run mix of debt and equity, which it gradually manages financing decisions toward, is its", options: ["WACC", "Target capital structure", "Cash conversion cycle", "Business model"], correct: 1, explanation: "This describes a target capital structure.", remediation: "corp-21" },
    { id: "corp-q19", question: "Connecting buyers and sellers and earning a fee on their transactions, without owning the underlying inventory, describes a", options: ["Subscription model", "Marketplace/platform model", "Franchise model", "Regulatory investment"], correct: 1, explanation: "This is the defining feature of a marketplace/platform business model.", remediation: "corp-23" },
  ],
  equity: [
    { id: "equity-q1", question: "Which security type is typically paid before common shareholders but usually has no vote?", options: ["Common stock", "Preferred stock", "A bond", "A call option"], correct: 1, explanation: "Preferred stock has priority over common stock but usually no voting rights.", remediation: "equity-1b" },
    ...
    { id: "equity-q7", question: "An investor buys a stock at $80 using 60% initial margin, with a 30% maintenance margin. What is the approximate margin call price?", options: ["$60.00", "$45.71", "$52.50", "$24.00"], correct: 1, explanation: "80 \u00D7 [(1\u22120.60)/(1\u22120.30)] = 80 \u00D7 (0.40/0.70) \u2248 $45.71.", remediation: "equity-3h" },
    ...
    { id: "equity-q12", question: "Compared to publicly traded equity, privately held equity generally offers owners", options: ["More liquidity and less privacy", "Less liquidity but more operating privacy", "Identical disclosure requirements", "No access to any capital at all"], correct: 1, explanation: "Private ownership sacrifices easy share liquidity in exchange for privacy and freedom from public market pressure.", remediation: "equity-1c" },
    { id: "equity-q13", question: "Independent firms that research shareholder proposals and issue voting recommendations, giving them outsized influence over institutional votes, are called", options: ["Asset owners", "Proxy advisors", "Sell-side analysts", "Underwriters"], correct: 1, explanation: "Proxy advisors research proposals and issue recommendations many institutional investors follow closely.", remediation: "equity-2b" },
    { id: "equity-q14", question: "A company's IPO, where new shares are sold directly to investors and proceeds go to the company, occurs in the", options: ["Secondary market", "Primary market", "OTC market only", "Dark pool"], correct: 1, explanation: "The primary market is where new shares are initially issued, with proceeds going to the issuing company.", remediation: "equity-3" },
    { id: "equity-q15", question: "A company has 50,000,000 total shares outstanding, of which 18,000,000 are held by insiders and restricted from trading. What is its float?", options: ["50,000,000", "18,000,000", "32,000,000", "68,000,000"], correct: 2, explanation: "Float = 50,000,000 \u2212 18,000,000 = 32,000,000 shares.", remediation: "equity-3c" },
    { id: "equity-q16", question: "A stock trades without the right to an upcoming dividend starting on the", options: ["Declaration date", "Ex-dividend date", "Payment date", "Record date only"], correct: 1, explanation: "The ex-dividend date is the first date a share trades without the right to the upcoming dividend.", remediation: "equity-3f" },
    { id: "equity-q17", question: "A stock begins the year at $40, ends at $46, and paid $1.50 in dividends. What is its total return?", options: ["15%", "18.75%", "3.75%", "20%"], correct: 1, explanation: "Total return = (46\u221240+1.50)/40 = 7.50/40 = 18.75%.", remediation: "equity-3g" },
    { id: "equity-q18", question: "The residual income model estimates value by starting from", options: ["Enterprise value", "Book value of equity, plus the PV of future residual income", "The most recent dividend only", "The company's P/E ratio"], correct: 1, explanation: "The residual income model starts from current book value and adds the present value of expected future residual income.", remediation: "equity-6a" },
    { id: "equity-q19", question: "A preferred stock pays a $4.50 annual dividend forever, with a 7% required return. What is it worth?", options: ["$31.50", "$64.29", "$45.00", "$7.00"], correct: 1, explanation: "V0 = 4.50 / 0.07 \u2248 $64.29.", remediation: "equity-6c" },
    { id: "equity-q20", question: "Valuing a stock by comparing its P/E to similar peer companies' P/E ratios is the", options: ["Method of forecasted fundamentals", "Method of comparables", "Residual income method", "Asset-based method"], correct: 1, explanation: "The method of comparables infers a fair multiple from what similar peer companies currently trade for.", remediation: "equity-7intro" },
    { id: "equity-q21", question: "A multiple based on next year's projected earnings, rather than the last twelve months' actual results, is a", options: ["Trailing multiple", "Forward (leading) multiple", "Current multiple", "Book multiple"], correct: 1, explanation: "A forward multiple uses a forecasted future figure rather than historical actuals.", remediation: "equity-7c" },
    { id: "equity-q22", question: "Grouping companies by cyclical vs. defensive business-cycle sensitivity is an example of", options: ["Porter's five forces", "Industry classification methods", "The PESTLE framework", "The residual income model"], correct: 1, explanation: "Industry classification systems are commonly built by products/services or by business-cycle sensitivity.", remediation: "equity-9b" },
    { id: "equity-q23", question: "Which framework specifically analyzes external political, economic, social, technological, legal, and environmental forces acting on an industry?", options: ["Porter's five forces", "PESTLE", "CAPM", "Residual income"], correct: 1, explanation: "PESTLE analyzes external macro forces, distinct from Porter's five forces' focus on internal competitive structure.", remediation: "equity-5b" },
    { id: "equity-q24", question: "A company's ability to raise prices without losing proportional volume is called", options: ["Operating leverage", "Pricing power", "The cash conversion cycle", "Float"], correct: 1, explanation: "Pricing power is a direct, observable indicator of a strong competitive position.", remediation: "equity-10b" },
    { id: "equity-q25", question: "Research produced by a brokerage and published broadly to its clients, potentially influenced by investment banking relationships, is", options: ["Buy-side research", "Sell-side research", "A regulatory filing", "An audit report"], correct: 1, explanation: "Sell-side research faces documented potential conflicts from banking relationships with covered companies.", remediation: "equity-11b" },
    { id: "equity-q26", question: "Arbitrage pricing theory (APT) generalizes CAPM by", options: ["Removing the risk-free rate entirely", "Allowing multiple systematic risk factors instead of just market beta", "Eliminating the need for a discount rate", "Applying only to bonds"], correct: 1, explanation: "APT allows for several distinct systematic risk factors, each with its own factor beta and risk premium.", remediation: "equity-12b" },
  ],
  fixedincome: [
  ...
  if (section.formulas && section.formulas.length) {
    section.formulas.forEach((f) => {
      ...
      const problemHtml = f.problem
        ? `<div class="led-problem">${f.problem}</div>`
        : "";
