  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "econ-9-hhi", name: "Herfindahl-Hirschman Index (HHI)", expression: "HHI = \u03A3 (market share)<sup>2</sup>, using shares as whole numbers (e.g., 25 for 25%)", when: "Measuring market concentration with more weight on large firms than a simple concentration ratio gives.", given: ["4 firms with market shares: 40%, 30%, 20%, 10%"], worked: "HHI = 40\u00B2 + 30\u00B2 + 20\u00B2 + 10\u00B2\nHHI = 1,600 + 900 + 400 + 100\nHHI = 3,000\n\n(higher HHI = more concentrated; regulators often\nflag markets above roughly 2,500 as highly concentrated)" },
        ],
      },
      {
        id: "econ-10",
      ...
      },
      {
        ...
        formulas: [
          { id: "econ-29-pctchange", name: "Percentage change in a currency's value", expression: "% change = <span class=\"frac\"><span class=\"num\">New rate \u2212 Old rate</span><span class=\"den\">Old rate</span></span>", when: "Measuring how much one currency has moved relative to another over a period.", given: ["Old rate (EUR/USD) = 1.05", "New rate (EUR/USD) = 1.12"], worked: "% change = (1.12 \u2212 1.05) / 1.05\n% change = 0.07 / 1.05\n% change \u2248 +6.67%\n\n(the euro strengthened about 6.67% against\nthe dollar, since more dollars are now needed\nto buy one euro)" },
        ],
      },
      {
        id: "econ-30",
      ...
      },
      {
        ...
        formulas: [
          { id: "econ-32-cross", name: "Cross rate calculation", expression: "(A/B) = (A/C) \u00D7 (C/B)", when: "Finding the exchange rate between two currencies, given each one's rate against a common third currency.", given: ["EUR/USD = 1.10", "GBP/USD = 1.25"], worked: "EUR/GBP = (EUR/USD) \u00F7 (GBP/USD)\nEUR/GBP = 1.10 / 1.25\nEUR/GBP = 0.88" },
        ],
      },
      {
        id: "econ-33",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          { id: "corp-15-npv", name: "Net present value (NPV)", expression: "NPV = (PV of future cash inflows) \u2212 (initial investment)", when: "Positive NPV = expected to add value; negative NPV = expected to destroy value.", given: ["Initial investment = $50,000", "PMT = $15,000/year", "n = 5", "r = 0.10"], worked: "PV of annuity \u2248 15,000 \u00D7 3.7908 \u2248 $56,862\n\nNPV \u2248 56,862 \u2212 50,000\nNPV \u2248 $6,862 (positive)" },
